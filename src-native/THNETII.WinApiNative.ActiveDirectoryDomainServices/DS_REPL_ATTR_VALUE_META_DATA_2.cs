...
{
    /// <summary>
    /// The <see cref="DS_REPL_ATTR_VALUE_META_DATA_2"/> structure is used with the <see cref="DsReplicaGetInfo2"/> function to provide metadata for a collection of attribute values.
    /// </summary>
    /// <remarks>
    /// <para>Original MSDN documentation page: <a href="https://docs.microsoft.com/en-us/windows/desktop/api/ntdsapi/ns-ntdsapi-_ds_repl_attr_value_meta_data_2">_DS_REPL_ATTR_VALUE_META_DATA_2 structure</a></para>
    /// </remarks>
    /// <seealso cref="DS_REPL_VALUE_META_DATA_2"/>
