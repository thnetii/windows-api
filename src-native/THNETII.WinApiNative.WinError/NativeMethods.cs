...
{
    /// <summary>
    /// Provides methods that mirror the functionality of the Windows Error
    /// macros.
    /// </summary>
    /// <remarks>
    /// <para>See the Microfost Docs documentation page: <a href="https://docs.microsoft.com/en-us/windows/desktop/api/winerror/#functions">winerror.h header</a></para>
    /// </remarks>
    public static class NativeMethods
    {
        ...
        /// </summary>
        /// <param name="hr">The status code. This value can be an <strong>HRESULT</strong> or an <strong>SCODE</strong>. A non-negative number indicates success.</param>
        ...
        /// </summary>
        /// <param name="hr">The status code. This value can be an <strong>HRESULT</strong> or an <strong>SCODE</strong>. A negative number indicates failure.</param>
        ...
        /// </summary>
        /// <param name="status">The status code. This value can be an <strong>HRESULT</strong> or an <strong>SCODE</strong>.</param>
        ...
        /// <summary>
        /// Extracts the code portion of the specified <strong>HRESULT</strong>.
        /// </summary>
        /// <param name="hr">The <strong>HRESULT</strong> value.</param>
        ...
        /// <summary>
        /// Extracts the facility of the specified <strong>HRESULT</strong>.
        /// </summary>
        /// <param name="hr">The <strong>HRESULT</strong> value.</param>
        ...
        /// <summary>
        /// Extracts the severity field of the specified <strong>HRESULT</strong>.
        /// </summary>
        /// <param name="hr">The <strong>HRESULT</strong>.</param>
        ...
        /// <summary>
        /// Creates an <strong>HRESULT</strong> value from its component pieces.
        /// </summary>
        /// <param name="sev">The severity.</param>
        /// <param name="fac">The facility.</param>
        /// <param name="code">The code.</param>
        /// <returns>An <strong>HRESULT</strong> value composed of the specified compoents.</returns>
        /// <remarks>
        ...
        /// <summary>
        /// Maps a <a href="https://msdn.microsoft.com/4a3a8feb-a05f-4614-8f04-1f507da7e5b7">system error code</a> to an <strong>HRESULT</strong> value.
        /// </summary>
        /// <param name="x">The system error code.</param>
        /// <returns>The system error code translated to an <strong>HRESULT</strong> value.</returns>
        /// <remarks>
        ...
        /// <summary>
        /// Maps an NT status value to an <strong>HRESULT</strong> value.
        /// </summary>
        /// <param name="x">The NT status value.</param>
        /// <returns>The NT status value mapped to an <strong>HRESULT</strong> value.</returns>
        /// <remarks>
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        #endregion
        #region HRESULT_FROM_SETUPAPI macro
        /// <summary>
        /// Since the SetupAPI error codes are not in the standard Win32 range (i.e. 0-64K),
        /// this method maps the specified Win32 or SetupAPI error code to an <strong>HRESULT</strong> value.
        /// </summary>
        public static int HRESULT_FROM_SETUPAPI(int x)
        {
            return (x & (APPLICATION_ERROR_MASK | ERROR_SEVERITY_ERROR)) == (APPLICATION_ERROR_MASK | ERROR_SEVERITY_ERROR)
                ? ((x & 0x0000FFFF) | (FACILITY_SETUPAPI << 16) | unchecked((int)0x80000000))
                : HRESULT_FROM_WIN32(x);
        }
        #endregion
        #region FILTER_HRESULT_FROM_FLT_NTSTATUS macro
        /// <summary>
        /// Translation macro for converting FilterManager error codes only from:
        /// <strong>NTSTATUS</strong> --&gt; <strong>HRESULT</strong>
        /// </summary>
        public static int FILTER_HRESULT_FROM_FLT_NTSTATUS(int x)
        {
            Debug.Assert((x & 0xfff0000) == 0x001c0000);
            return (x & unchecked((int)0x8000FFFF))
