...
namespace THNETII.WinApi.Native.WinNT
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>The number of directories is not fixed. Check the <see cref="NumberOfRvaAndSizes"/> member before looking for a specific directory.</para>
    /// <para>Microsoft Docs page: <a href="https://docs.microsoft.com/en-us/windows/desktop/api/winnt/ns-winnt-image_optional_header32">IMAGE_OPTIONAL_HEADER32 structure</a></para>
    /// </remarks>
