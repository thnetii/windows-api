...
namespace THNETII.WinApi.Native.WinNT
{
    ...
    {
        private static readonly Bitfield32 bfRaiseExceptionOnInvalidHandleReference = Bitfield32.DefineLowerBits(1);
        private static readonly Bitfield32 bfHandleExceptionsPermanentlyEnabled = Bitfield32.DefineMiddleBits(1, 1);
        ...
        {
            get => bfRaiseExceptionOnInvalidHandleReference.Read(dwFlags) != 0;
            set => bfRaiseExceptionOnInvalidHandleReference.Write(ref dwFlags, value ? 1U : 0U);
        }

        public bool HandleExceptionsPermanentlyEnabled
        {
            get => bfHandleExceptionsPermanentlyEnabled.Read(dwFlags) != 0;
            set => bfHandleExceptionsPermanentlyEnabled.Write(ref dwFlags, value ? 1U : 0U);
        }
