...
using static THNETII.WinApi.Native.ActiveDirectoryDomainServices.DS_NAME_ERROR;
using static THNETII.WinApi.Native.ActiveDirectoryDomainServices.DS_NAME_FORMAT;
