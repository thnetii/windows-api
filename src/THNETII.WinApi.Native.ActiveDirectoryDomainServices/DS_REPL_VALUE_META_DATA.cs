...
{
    /// <summary>
    /// The <see cref="DS_REPL_VALUE_META_DATA"/> structure is used with the <see cref="DS_REPL_ATTR_VALUE_META_DATA"/> structure to contain attribute value replication metadata.
    /// </summary>
    /// <remarks>
    /// <para>Original MSDN documentation page: <a href="https://docs.microsoft.com/en-us/windows/desktop/api/ntdsapi/ne-ntdsapi-_ds_repl_value_meta_data">_DS_REPL_VALUE_META_DATA structure</a></para>
    /// </remarks>
    ...
    public struct DS_REPL_VALUE_META_DATA
    {
        ...
        public Span<byte> spanData
        {
            get
            {
                if (pbData == IntPtr.Zero || cbData < 0)
