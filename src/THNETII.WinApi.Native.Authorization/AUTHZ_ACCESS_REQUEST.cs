...
namespace Microsoft.Win32.WinApi.SecurityIdentity.Authorization
{
    ...
    public class AUTHZ_ACCESS_REQUEST
    {
        ...
        public SecurityIdentifier GetMarshaledPrincipalSelfSid() => PrincipalSelfSid == IntPtr.Zero ? null : new SecurityIdentifier(PrincipalSelfSid);
        /// <summary>
        ...
        /// </summary>
        public ValueArraySafeHandle<OBJECT_TYPE_LIST> ObjectTypeList;
        /// <summary>
