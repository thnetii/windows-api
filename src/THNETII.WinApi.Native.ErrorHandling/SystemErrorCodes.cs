...
namespace Microsoft.Win32.WinApi.Diagnostics.ErrorHandling
{
    ...
    /// <para>System Error Codes are returned by the <see cref="Marshal.GetLastWin32Error"/> function when many functions fail. To retrieve the description text for the error in your application, use the <see cref="FormatMessage(FORMAT_MESSAGE_FLAG, System.IntPtr, int, int, System.Text.StringBuilder, int, System.IntPtr)"/> function with the <see cref="FORMAT_MESSAGE_FROM_SYSTEM"/> flag.</para>
    /// </summary>
    public static class SystemErrorCodes
    {
        ...
        public const int ERROR_CLUSTER_NODE_EVACUATION_IN_PROGRESS = 5962;
        ...
        public const int DNS_ERROR_INVALID_NSEC3_PARAMETERS = 9103;
