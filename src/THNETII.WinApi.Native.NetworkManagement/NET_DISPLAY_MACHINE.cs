...
{
    /// <summary>
    /// The <see cref="NET_DISPLAY_MACHINE"/> structure contains information that an account manager can access to determine information about computers and their attributes.
    /// </summary>
    /// <remarks>
    /// <para>Original MSDN documentation page: <a href="https://msdn.microsoft.com/en-us/library/aa370683.aspx">NET_DISPLAY_MACHINE structure</a></para>
    /// </remarks>
    /// <seealso cref="NetUserAdd"/>
    /// <seealso cref="NetUserSetInfo"/>
    /// <seealso cref="NetQueryDisplayInformation"/>
    [StructLayout(LayoutKind.Sequential)]
    public class NET_DISPLAY_MACHINE
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.I4)] USER_FLAGS usri2_flags;
        /// <summary>
