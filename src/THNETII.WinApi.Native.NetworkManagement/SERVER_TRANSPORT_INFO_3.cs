...
namespace Microsoft.Win32.WinApi.Networking.NetworkManagement
{
    ...
    public class SERVER_TRANSPORT_INFO_3
    {
        ...
        /// </summary>
        public ByteArraySafeHandle svti3_transportaddress;
        /// <summary>
        ...
        public byte[] GetTransportAddress() => svti3_transportaddress?.MarshalToManagedArray(svti3_transportaddresslength);
        /// <summary>
