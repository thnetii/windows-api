...
namespace Microsoft.Win32.WinApi.Networking.NetworkManagement
{
    ...
    public class USER_INFO_1020
    {
        ...
        /// </summary>
        public ByteArraySafeHandle usri1020_logon_hours;
        /// <summary>
        ...
        public BitArray GetLogonHoursBitArray() => new BitArray(usri1020_logon_hours?.MarshalToManagedArray(usri1020_units_per_week / 8) ?? new byte[0]);
    }
}
