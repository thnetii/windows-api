...
namespace Microsoft.Win32.WinApi.Networking.NetworkManagement
{
    ...
    public class USER_INFO_11
    {
        ...
        /// </summary>
        public ByteArraySafeHandle usri11_logon_hours;
        /// <summary>
        ...
        public BitArray GetLogonHoursBitArray() => new BitArray(usri11_logon_hours?.MarshalToManagedArray(usri11_units_per_week / 8) ?? new byte[0]);
