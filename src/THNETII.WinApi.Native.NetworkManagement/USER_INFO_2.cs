...
namespace Microsoft.Win32.WinApi.Networking.NetworkManagement
{
    ...
    public class USER_INFO_2
    {
        ...
        /// </summary>
        public ByteArraySafeHandle usri2_logon_hours;
        /// <summary>
        ...
        public BitArray GetLogonHoursBitArray() => new BitArray(usri2_logon_hours?.MarshalToManagedArray(usri2_units_per_week / 8) ?? new byte[0]);
        /// <summary>
