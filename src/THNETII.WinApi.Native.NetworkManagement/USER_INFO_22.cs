...
{
    /// <summary>
    /// The <see cref="USER_INFO_22"/> structure contains information about a user account, including the account name, privilege level, the path to the user's home directory, a one-way encrypted LAN Manager 2.x-compatible password, and other user-related network statistics.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Original MSDN documentation page: <a href="https://msdn.microsoft.com/en-us/library/aa371129.aspx">USER_INFO_22 structure</a></para>
    /// </remarks>
    ...
    public class USER_INFO_22
    {
        ...
        /// <summary>
        /// The number of seconds that have elapsed since the <see cref="usri22_password"/> member was last changed. The <see cref="NetUserAdd"/> and <see cref="NetUserSetInfo"/> functions ignore this member.
        /// </summary>
        public int usri22_password_age;
        /// <summary>
        /// The time that has elapsed since the <see cref="usri22_password"/> member was last changed.
        /// </summary>
        public TimeSpan PasswordAge => TimeSpan.FromSeconds(usri22_password_age);
        /// <summary>
        /// The level of privilege assigned to the <see cref="usri22_name"/> member. When you call the <see cref="NetUserAdd"/> function, this member must be <see cref="USER_PRIV_USER"/>. When you call the <see cref="NetUserSetInfo"/> function, this member must be the value returned by the <see cref="NetUserGetInfo"/> function or the <see cref="NetUserEnum"/> function. For more information about user and group account rights, see <a href="https://msdn.microsoft.com/en-us/library/aa379306.aspx">Privileges</a>. 
        /// </summary>
        [MarshalAs(UnmanagedType.I4)]
        public USER_PRIVILEGE_LEVEL usri22_priv;
        /// <summary>
        /// A string specifying the path of the home directory for the user specified in the <see cref="usri22_name"/> member. The string can be <c>null</c>.
        /// </summary>
        [MarshalAs(UnmanagedType.LPWStr)]
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.I4)]
        public USER_FLAGS usri22_flags;
        /// <summary>
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.I4)]
        public ACCOUNT_OPERATOR_FLAGS usri22_auth_flags;
        /// <summary>
        ...
        /// </summary>
        public int usri22_last_logon;
        /// <summary>
        /// The date and time when the last logon occurred, expressed as a <see cref="DateTime"/> value using the local time of the system.
        /// </summary>
        /// <seealso cref="usri22_last_logon"/>
        public DateTime LastLogon => epoch.AddSeconds((uint)usri22_last_logon).ToLocalTime();
        /// <summary>
        ...
        /// </summary>
        public int usri22_last_logoff;
        /// <summary>
        /// Indicates when the last logoff occurred, expressed as a <see cref="DateTime"/> value using the local time of the system.
        /// </summary>
        /// <seealso cref="usri22_last_logoff"/>
        public DateTime LastLogoff => (usri22_last_logoff == 0 ? default(DateTime) : epoch.AddSeconds((uint)usri22_last_logoff).ToLocalTime());
        /// <summary>
        ...
        /// </summary>
        public int usri22_acct_expires;
        /// <summary>
        ...
        {
            get { return usri22_acct_expires == TIMEQ_FOREVER ? DateTime.MaxValue : epoch.AddSeconds((uint)usri22_acct_expires).ToLocalTime(); }
            set
            {
                if (value == default(DateTime))
                    usri22_acct_expires = 0;
                else if (value == DateTime.MaxValue)
                    usri22_acct_expires = TIMEQ_FOREVER;
                else
                    usri22_acct_expires = (int)((uint)(value - epoch).TotalSeconds);
            }
        }
        /// <summary>
        ...
        /// <summary>
        /// <para>The number of equal-length time units into which the week is divided. This value is required to compute the length of the bit string in the <see cref="usri22_logon_hours"/> member. </para>
        ...
        /// </summary>
        public int usri22_units_per_week;
        /// <summary>
        ...
        /// </summary>
        public ByteArrayAnySafeHandle usri22_logon_hours;
        /// <summary>
        /// Gets the marshaled bit array containing the logon hours during which the user can log on.
        /// </summary>
        /// <returns>A bit array containing exactly <see cref="usri22_units_per_week"/> bits, or zero bits if <see cref="usri22_logon_hours"/> is <c>null</c>.</returns>
        /// <seealso cref="usri22_logon_hours"/>
        /// <seealso cref="usri22_units_per_week"/>
        public BitArray GetLogonHoursBitArray() => new BitArray(ByteArraySafeHandle.ReadValue(usri22_logon_hours, usri22_units_per_week / 8) ?? new byte[0]);
        /// <summary>
        ...
        /// </summary>
        public int usri22_bad_pw_count;
        /// <summary>
        ...
        /// </summary>
        public int usri22_country_code;
        /// <summary>
        /// The code page for the user's language of choice.
        /// <para>This value is ignored.</para>
        /// </summary>
        public int usri22_code_page;
    }
}
