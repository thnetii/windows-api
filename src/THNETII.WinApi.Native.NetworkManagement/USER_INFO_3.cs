...
namespace Microsoft.Win32.WinApi.Networking.NetworkManagement
{
    ...
    public class USER_INFO_3
    {
        ...
        /// </summary>
        public ByteArraySafeHandle usri3_logon_hours;
        /// <summary>
        ...
        public BitArray GetLogonHoursBitArray() => new BitArray(usri3_logon_hours?.MarshalToManagedArray(usri3_units_per_week / 8) ?? new byte[0]);
        /// <summary>
