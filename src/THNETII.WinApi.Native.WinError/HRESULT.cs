namespace Microsoft.Win32.WinApi.WinError
{
    ...
    /// Most values also have a default message defined, which can be used to map the value to a human-readable text message; when this is done, the <see cref="HRESULT"/> value is also known as a message identifier.
    /// </summary>
    /// <remarks>
    /// <strong>Note</strong>: In the following field descriptions, a percentage sign (%) followed by one or more alphanumeric characters (for example, "%1" or "%hs") indicates a variable that is replaced by text at the time the value is returned. 
    /// </remarks>
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        XACT_E_CONNECTION_REQUEST_DENIED = unchecked((int)0x8004D100),

        /// <summary>The maximum number of enlistments for the specified transaction has been reached.</summary>
        XACT_E_TOOMANY_ENLISTMENTS = unchecked((int)0x8004D101),
        ...
        ERROR_MONITOR_NO_DESCRIPTOR = unchecked((int)0x80261001),

        /// <summary>Format of the obtained monitor descriptor is not supported by this release.</summary>
        ERROR_MONITOR_UNKNOWN_DESCRIPTOR_FORMAT = unchecked((int)0x80261002),
        ...
        FVE_E_FAILED_BAD_FS = unchecked((int)0x80310014),
        ...
        FWP_E_TOO_MANY_BOOTTIME_FILTERS = unchecked((int)0x80320018),
        ...
        ERROR_NDIS_INVALID_PORT_STATE = unchecked((int)0x8034002E),

        /// <summary>The network interface does not support this request.</summary>
        ERROR_NDIS_NOT_SUPPORTED = unchecked((int)0x803400BB),
        ...
        TRK_E_VOLUME_QUOTA_EXCEEDED = unchecked((int)0x8DEAD01C),

        /// <summary>The server is busy, and the client should retry the request at a later time.</summary>
        TRK_SERVER_TOO_BUSY = unchecked((int)0x8DEAD01E),
        ...
        NS_E_TIMEOUT = unchecked((int)0xC00D0013),

        /// <summary>Error writing to the network.</summary>
        NS_E_NET_WRITE = unchecked((int)0xC00D0014),

        /// <summary>Error reading from the network.</summary>
        NS_E_NET_READ = unchecked((int)0xC00D0015),

        /// <summary>Error writing to a disk.</summary>
        NS_E_DISK_WRITE = unchecked((int)0xC00D0016),

        /// <summary>Error reading from a disk.</summary>
        NS_E_DISK_READ = unchecked((int)0xC00D0017),

        /// <summary>Error writing to a file.</summary>
        NS_E_FILE_WRITE = unchecked((int)0xC00D0018),

        /// <summary>Error reading from a file.</summary>
        NS_E_FILE_READ = unchecked((int)0xC00D0019),

        /// <summary>The system cannot find the file specified.</summary>
        NS_E_FILE_NOT_FOUND = unchecked((int)0xC00D001A),

        /// <summary>The file already exists.</summary>
        NS_E_FILE_EXISTS = unchecked((int)0xC00D001B),

        /// <summary>The file name, directory name, or volume label syntax is incorrect.</summary>
        NS_E_INVALID_NAME = unchecked((int)0xC00D001C),

        /// <summary>Failed to open a file.</summary>
        NS_E_FILE_OPEN_FAILED = unchecked((int)0xC00D001D),

        /// <summary>Unable to allocate a file.</summary>
        NS_E_FILE_ALLOCATION_FAILED = unchecked((int)0xC00D001E),

        /// <summary>Unable to initialize a file.</summary>
        NS_E_FILE_INIT_FAILED = unchecked((int)0xC00D001F),

        /// <summary>Unable to play a file.</summary>
        NS_E_FILE_PLAY_FAILED = unchecked((int)0xC00D0020),

        /// <summary>Could not set the disk UID.</summary>
        NS_E_SET_DISK_UID_FAILED = unchecked((int)0xC00D0021),

        /// <summary>An error was induced for testing purposes.</summary>
        NS_E_INDUCED = unchecked((int)0xC00D0022),

        /// <summary>Two Content Servers failed to communicate.</summary>
        NS_E_CCLINK_DOWN = unchecked((int)0xC00D0023),

        /// <summary>An unknown error occurred.</summary>
        NS_E_INTERNAL = unchecked((int)0xC00D0024),

        /// <summary>The requested resource is in use.</summary>
        NS_E_BUSY = unchecked((int)0xC00D0025),
        ...
        NS_E_CANT_READ_DIGITAL = unchecked((int)0xC00D0FA1),
        ...
        NS_E_MP3_FORMAT_NOT_FOUND = unchecked((int)0xC00D0FAA),
        ...
        NS_E_CD_READ_ERROR_NO_CORRECTION = unchecked((int)0xC00D0FAB),
        ...
        NS_E_CD_READ_ERROR = unchecked((int)0xC00D0FAC),

        /// <summary>For best performance, do not play CD tracks while ripping them.</summary>
        NS_E_CD_SLOW_COPY = unchecked((int)0xC00D0FAD),
        ...
        NS_E_CD_COPYTO_CD = unchecked((int)0xC00D0FAE),

        /// <summary>Could not open a sound mixer driver.</summary>
        NS_E_MIXER_NODRIVER = unchecked((int)0xC00D0FAF),
        ...
        NS_E_REDBOOK_ENABLED_WHILE_COPYING = unchecked((int)0xC00D0FB0),

        /// <summary>Windows Media Player is busy reading the CD.</summary>
        NS_E_CD_REFRESH = unchecked((int)0xC00D0FB1),

        /// <summary>Windows Media Player could not use digital playback to play the CD. The Player has automatically switched the CD drive to analog playback. To switch back to digital CD playback, use the Devices tab. For additional assistance, click Web Help.</summary>
        NS_E_CD_DRIVER_PROBLEM = unchecked((int)0xC00D0FB2),

        /// <summary>Windows Media Player could not use digital playback to play the CD. The Player has automatically switched the CD drive to analog playback. To switch back to digital CD playback, use the Devices tab. For additional assistance, click Web Help.</summary>
        NS_E_WONT_DO_DIGITAL = unchecked((int)0xC00D0FB3),

        /// <summary>A call was made to GetParseError on the XML parser but there was no error to retrieve.</summary>
        NS_E_WMPXML_NOERROR = unchecked((int)0xC00D0FB4),

        /// <summary>The XML Parser ran out of data while parsing.</summary>
        NS_E_WMPXML_ENDOFDATA = unchecked((int)0xC00D0FB5),

        /// <summary>A generic parse error occurred in the XML parser but no information is available.</summary>
        NS_E_WMPXML_PARSEERROR = unchecked((int)0xC00D0FB6),
        ...
        NS_E_WMP_FILESCANALREADYSTARTED = unchecked((int)0xC00D0FBE),

        /// <summary>Windows Media Player is unable to find the media you are looking for.</summary>
        NS_E_WMP_HME_INVALIDOBJECTID = unchecked((int)0xC00D0FBF),
        ...
        NS_E_WMP_MF_CODE_EXPIRED = unchecked((int)0xC00D0FC0),

        /// <summary>This container does not support search on items.</summary>
        NS_E_WMP_HME_NOTSEARCHABLEFORITEMS = unchecked((int)0xC00D0FC1),
        ...
        NS_E_WMP_ADDTOLIBRARY_FAILED = unchecked((int)0xC00D0FC7),

        /// <summary>A Windows API call failed but no error information was available.</summary>
        NS_E_WMP_WINDOWSAPIFAILURE = unchecked((int)0xC00D0FC8),
        ...
        NS_E_WMP_RECORDING_NOT_ALLOWED = unchecked((int)0xC00D0FC9),
        ...
        NS_E_DEVICE_NOT_READY = unchecked((int)0xC00D0FCA),

        /// <summary>Windows Media Player cannot play the file because it is corrupted.</summary>
        NS_E_DAMAGED_FILE = unchecked((int)0xC00D0FCB),
        ...
        NS_E_MPDB_GENERIC = unchecked((int)0xC00D0FCC),
        ...
        NS_E_FILE_FAILED_CHECKS = unchecked((int)0xC00D0FCD),
        ...
        NS_E_MEDIA_LIBRARY_FAILED = unchecked((int)0xC00D0FCE),
        ...
        NS_E_SHARING_VIOLATION = unchecked((int)0xC00D0FCF),

        /// <summary>Windows Media Player has encountered an unknown error.</summary>
        NS_E_NO_ERROR_STRING_FOUND = unchecked((int)0xC00D0FD0),
        ...
        NS_E_WMPOCX_NO_REMOTE_CORE = unchecked((int)0xC00D0FD1),
        ...
        NS_E_WMPOCX_NO_ACTIVE_CORE = unchecked((int)0xC00D0FD2),

        /// <summary>The Windows Media Player ActiveX control is not running in remote mode.</summary>
        NS_E_WMPOCX_NOT_RUNNING_REMOTELY = unchecked((int)0xC00D0FD3),

        /// <summary>An error occurred while trying to get the remote Windows Media Player window.</summary>
        NS_E_WMPOCX_NO_REMOTE_WINDOW = unchecked((int)0xC00D0FD4),

        /// <summary>Windows Media Player has encountered an unknown error.</summary>
        NS_E_WMPOCX_ERRORMANAGERNOTAVAILABLE = unchecked((int)0xC00D0FD5),
        ...
        NS_E_PLUGIN_NOTSHUTDOWN = unchecked((int)0xC00D0FD6),
        ...
        NS_E_WMP_CANNOT_FIND_FOLDER = unchecked((int)0xC00D0FD7),

        /// <summary>Windows Media Player cannot save a file that is being streamed.</summary>
        NS_E_WMP_STREAMING_RECORDING_NOT_ALLOWED = unchecked((int)0xC00D0FD8),
        ...
        NS_E_WMP_URLDOWNLOADFAILED = unchecked((int)0xC00D0FEA),
        ...
        NS_E_WMP_FAILED_TO_SAVE_FILE = unchecked((int)0xC00D0FEF),

        /// <summary>Windows Media Player cannot overwrite a read-only file. Try using a different file name.</summary>
        NS_E_WMP_SAVEAS_READONLY = unchecked((int)0xC00D0FF0),
        ...
        NS_E_WMP_FAILED_TO_SAVE_PLAYLIST = unchecked((int)0xC00D0FF1),

        /// <summary>Windows Media Player cannot open the Windows Media Download file. The file might be damaged.</summary>
        NS_E_WMP_FAILED_TO_OPEN_WMD = unchecked((int)0xC00D0FF2),
        ...
        NS_E_WMP_CANT_PLAY_PROTECTED = unchecked((int)0xC00D0FF3),
        ...
        NS_E_WMPZIP_FILENOTFOUND = unchecked((int)0xC00D101A),

        /// <summary>Image type not supported.</summary>
        NS_E_WMP_IMAGE_FILETYPE_UNSUPPORTED = unchecked((int)0xC00D1022),

        /// <summary>Image file might be corrupt.</summary>
        NS_E_WMP_IMAGE_INVALID_FORMAT = unchecked((int)0xC00D1023),

        /// <summary>Unexpected end of file. GIF file might be corrupt.</summary>
        NS_E_WMP_GIF_UNEXPECTED_ENDOFFILE = unchecked((int)0xC00D1024),

        /// <summary>Invalid GIF file.</summary>
        NS_E_WMP_GIF_INVALID_FORMAT = unchecked((int)0xC00D1025),

        /// <summary>Invalid GIF version. Only 87a or 89a supported.</summary>
        NS_E_WMP_GIF_BAD_VERSION_NUMBER = unchecked((int)0xC00D1026),

        /// <summary>No images found in GIF file.</summary>
        NS_E_WMP_GIF_NO_IMAGE_IN_FILE = unchecked((int)0xC00D1027),

        /// <summary>Invalid PNG image file format.</summary>
        NS_E_WMP_PNG_INVALIDFORMAT = unchecked((int)0xC00D1028),

        /// <summary>PNG bitdepth not supported.</summary>
        NS_E_WMP_PNG_UNSUPPORTED_BITDEPTH = unchecked((int)0xC00D1029),

        /// <summary>Compression format defined in PNG file not supported,</summary>
        NS_E_WMP_PNG_UNSUPPORTED_COMPRESSION = unchecked((int)0xC00D102A),

        /// <summary>Filter method defined in PNG file not supported.</summary>
        NS_E_WMP_PNG_UNSUPPORTED_FILTER = unchecked((int)0xC00D102B),

        /// <summary>Interlace method defined in PNG file not supported.</summary>
        NS_E_WMP_PNG_UNSUPPORTED_INTERLACE = unchecked((int)0xC00D102C),

        /// <summary>Bad CRC in PNG file.</summary>
        NS_E_WMP_PNG_UNSUPPORTED_BAD_CRC = unchecked((int)0xC00D102D),

        /// <summary>Invalid bitmask in BMP file.</summary>
        NS_E_WMP_BMP_INVALID_BITMASK = unchecked((int)0xC00D102E),

        /// <summary>Topdown DIB not supported.</summary>
        NS_E_WMP_BMP_TOPDOWN_DIB_UNSUPPORTED = unchecked((int)0xC00D102F),

        /// <summary>Bitmap could not be created.</summary>
        NS_E_WMP_BMP_BITMAP_NOT_CREATED = unchecked((int)0xC00D1030),

        /// <summary>Compression format defined in BMP not supported.</summary>
        NS_E_WMP_BMP_COMPRESSION_UNSUPPORTED = unchecked((int)0xC00D1031),

        /// <summary>Invalid Bitmap format.</summary>
        NS_E_WMP_BMP_INVALID_FORMAT = unchecked((int)0xC00D1032),

        /// <summary>JPEG Arithmetic coding not supported.</summary>
        NS_E_WMP_JPG_JERR_ARITHCODING_NOTIMPL = unchecked((int)0xC00D1033),

        /// <summary>Invalid JPEG format.</summary>
        NS_E_WMP_JPG_INVALID_FORMAT = unchecked((int)0xC00D1034),

        /// <summary>Invalid JPEG format.</summary>
        NS_E_WMP_JPG_BAD_DCTSIZE = unchecked((int)0xC00D1035),

        /// <summary>Internal version error. Unexpected JPEG library version.</summary>
        NS_E_WMP_JPG_BAD_VERSION_NUMBER = unchecked((int)0xC00D1036),

        /// <summary>Internal JPEG Library error. Unsupported JPEG data precision.</summary>
        NS_E_WMP_JPG_BAD_PRECISION = unchecked((int)0xC00D1037),

        /// <summary>JPEG CCIR601 not supported.</summary>
        NS_E_WMP_JPG_CCIR601_NOTIMPL = unchecked((int)0xC00D1038),

        /// <summary>No image found in JPEG file.</summary>
        NS_E_WMP_JPG_NO_IMAGE_IN_FILE = unchecked((int)0xC00D1039),

        /// <summary>Could not read JPEG file.</summary>
        NS_E_WMP_JPG_READ_ERROR = unchecked((int)0xC00D103A),

        /// <summary>JPEG Fractional sampling not supported.</summary>
        NS_E_WMP_JPG_FRACT_SAMPLE_NOTIMPL = unchecked((int)0xC00D103B),

        /// <summary>JPEG image too large. Maximum image size supported is 65500 X 65500.</summary>
        NS_E_WMP_JPG_IMAGE_TOO_BIG = unchecked((int)0xC00D103C),

        /// <summary>Unexpected end of file reached in JPEG file.</summary>
        NS_E_WMP_JPG_UNEXPECTED_ENDOFFILE = unchecked((int)0xC00D103D),

        /// <summary>Unsupported JPEG SOF marker found.</summary>
        NS_E_WMP_JPG_SOF_UNSUPPORTED = unchecked((int)0xC00D103E),

        /// <summary>Unknown JPEG marker found.</summary>
        NS_E_WMP_JPG_UNKNOWN_MARKER = unchecked((int)0xC00D103F),
        ...
        NS_E_WMG_INVALID_COPP_CERTIFICATE = unchecked((int)0xC00D1051),
        ...
        NS_E_WMR_CANNOT_RENDER_BINARY_STREAM = unchecked((int)0xC00D1063),
        ...
        NS_E_MLS_SMARTPLAYLIST_FILTER_NOT_REGISTERED = unchecked((int)0xC00D1075),
        ...
        NS_E_WMX_INVALID_FORMAT_OVER_NESTING = unchecked((int)0xC00D1076),
        ...
        NS_E_WMPCORE_UNRECOGNIZED_MEDIA_URL = unchecked((int)0xC00D1089),

        /// <summary>Graph with the specified URL was not found in the prerolled graph list.</summary>
        NS_E_WMPCORE_GRAPH_NOT_IN_LIST = unchecked((int)0xC00D108A),
        ...
        NS_E_WMPCORE_PLAYLIST_EMPTY_OR_SINGLE_MEDIA = unchecked((int)0xC00D108B),

        /// <summary>An error sink was never registered for the calling object.</summary>
        NS_E_WMPCORE_ERRORSINKNOTREGISTERED = unchecked((int)0xC00D108C),

        /// <summary>The error manager is not available to respond to errors.</summary>
        NS_E_WMPCORE_ERRORMANAGERNOTAVAILABLE = unchecked((int)0xC00D108D),

        /// <summary>The Web Help URL cannot be opened.</summary>
        NS_E_WMPCORE_WEBHELPFAILED = unchecked((int)0xC00D108E),

        /// <summary>Could not resume playing next item in playlist.</summary>
        NS_E_WMPCORE_MEDIA_ERROR_RESUME_FAILED = unchecked((int)0xC00D108F),
        ...
        NS_E_WMPCORE_NO_REF_IN_ENTRY = unchecked((int)0xC00D1090),

        /// <summary>An empty string for playlist attribute name was found.</summary>
        NS_E_WMPCORE_WMX_LIST_ATTRIBUTE_NAME_EMPTY = unchecked((int)0xC00D1091),

        /// <summary>A playlist attribute name that is not valid was found.</summary>
        NS_E_WMPCORE_WMX_LIST_ATTRIBUTE_NAME_ILLEGAL = unchecked((int)0xC00D1092),

        /// <summary>An empty string for a playlist attribute value was found.</summary>
        NS_E_WMPCORE_WMX_LIST_ATTRIBUTE_VALUE_EMPTY = unchecked((int)0xC00D1093),

        /// <summary>An illegal value for a playlist attribute was found.</summary>
        NS_E_WMPCORE_WMX_LIST_ATTRIBUTE_VALUE_ILLEGAL = unchecked((int)0xC00D1094),

        /// <summary>An empty string for a playlist item attribute name was found.</summary>
        NS_E_WMPCORE_WMX_LIST_ITEM_ATTRIBUTE_NAME_EMPTY = unchecked((int)0xC00D1095),

        /// <summary>An illegal value for a playlist item attribute name was found.</summary>
        NS_E_WMPCORE_WMX_LIST_ITEM_ATTRIBUTE_NAME_ILLEGAL = unchecked((int)0xC00D1096),

        /// <summary>An illegal value for a playlist item attribute was found.</summary>
        NS_E_WMPCORE_WMX_LIST_ITEM_ATTRIBUTE_VALUE_EMPTY = unchecked((int)0xC00D1097),

        /// <summary>The playlist does not contain any items.</summary>
        NS_E_WMPCORE_LIST_ENTRY_NO_REF = unchecked((int)0xC00D1098),
        ...
        NS_E_WMPCORE_CODEC_NOT_FOUND = unchecked((int)0xC00D109B),
        ...
        NS_E_WMPCORE_CODEC_DOWNLOAD_NOT_ALLOWED = unchecked((int)0xC00D109C),
        ...
        NS_E_WMPCORE_PLAYLIST_IMPORT_FAILED_NO_ITEMS = unchecked((int)0xC00D10B1),

        /// <summary>An error has occurred that could prevent the changing of the video contrast on this media.</summary>
        NS_E_WMPCORE_VIDEO_TRANSFORM_FILTER_INSERTION = unchecked((int)0xC00D10B2),
        ...
        NS_E_WMPCORE_MEDIA_UNAVAILABLE = unchecked((int)0xC00D10B3),

        /// <summary>The playlist contains an ENTRYREF for which no href was parsed. Check the syntax of playlist file.</summary>
        NS_E_WMPCORE_WMX_ENTRYREF_NO_REF = unchecked((int)0xC00D10B4),
        ...
        NS_E_GRAPH_NOAUDIOLANGUAGE = unchecked((int)0xC00D10C5),

        /// <summary>The graph has no audio language selected.</summary>
        NS_E_GRAPH_NOAUDIOLANGUAGESELECTED = unchecked((int)0xC00D10C6),

        /// <summary>This is not a media CD.</summary>
        NS_E_CORECD_NOTAMEDIACD = unchecked((int)0xC00D10C7),

        /// <summary>Windows Media Player cannot play the file because the URL is too long.</summary>
        NS_E_WMPCORE_MEDIA_URL_TOO_LONG = unchecked((int)0xC00D10C8),
        ...
        NS_E_WMPFLASH_CANT_FIND_COM_SERVER = unchecked((int)0xC00D10C9),
        ...
        NS_E_WMPFLASH_INCOMPATIBLEVERSION = unchecked((int)0xC00D10CA),
        ...
        NS_E_WMP_FAILED_TO_RIP_TRACK = unchecked((int)0xC00D10D3),
        ...
        NS_E_WMP_ERASE_FAILED = unchecked((int)0xC00D10D4),
        ...
        NS_E_WMP_FORMAT_FAILED = unchecked((int)0xC00D10D5),

        /// <summary>This file cannot be burned to a CD because it is not located on your computer.</summary>
        NS_E_WMP_CANNOT_BURN_NON_LOCAL_FILE = unchecked((int)0xC00D10D6),
        ...
        NS_E_WMP_FILE_TYPE_CANNOT_BURN_TO_AUDIO_CD = unchecked((int)0xC00D10D7),

        /// <summary>This file is too large to fit on a disc.</summary>
        NS_E_WMP_FILE_DOES_NOT_FIT_ON_CD = unchecked((int)0xC00D10D8),
        ...
        NS_E_WMP_FILE_NO_DURATION = unchecked((int)0xC00D10D9),
        ...
        NS_E_PDA_FAILED_TO_BURN = unchecked((int)0xC00D10DA),
        ...
        NS_E_FAILED_DOWNLOAD_ABORT_BURN = unchecked((int)0xC00D10DC),
        ...
        NS_E_WMPCORE_DEVICE_DRIVERS_MISSING = unchecked((int)0xC00D10DD),
        ...
        NS_E_WMPBR_ERRORWITHURL = unchecked((int)0xC00D1133),

        /// <summary>Your media usage rights were not backed up because the backup was canceled.</summary>
        NS_E_WMPBR_NAMECOLLISION = unchecked((int)0xC00D1134),
        ...
        NS_E_WMPBR_DRIVE_INVALID = unchecked((int)0xC00D1137),

        /// <summary>Windows Media Player cannot backup or restore your media usage rights.</summary>
        NS_E_WMPBR_BACKUPRESTOREFAILED = unchecked((int)0xC00D1138),

        /// <summary>Windows Media Player cannot add the file to the library.</summary>
        NS_E_WMP_CONVERT_FILE_FAILED = unchecked((int)0xC00D1158),
        ...
        NS_E_WMP_CONVERT_NO_RIGHTS_ERRORURL = unchecked((int)0xC00D1159),

        /// <summary>Windows Media Player cannot add the file to the library because the content provider prohibits it. For assistance, contact the company that provided the file.</summary>
        NS_E_WMP_CONVERT_NO_RIGHTS_NOERRORURL = unchecked((int)0xC00D115A),

        /// <summary>Windows Media Player cannot add the file to the library. The file might not be valid.</summary>
        NS_E_WMP_CONVERT_FILE_CORRUPT = unchecked((int)0xC00D115B),
        ...
        NS_E_WMP_CONVERT_PLUGIN_UNAVAILABLE_ERRORURL = unchecked((int)0xC00D115C),
        ...
        NS_E_WMP_CONVERT_PLUGIN_UNAVAILABLE_NOERRORURL = unchecked((int)0xC00D115D),

        /// <summary>Windows Media Player cannot add the file to the library. The plug-in required to add the file is not installed properly. For assistance, contact the company that provided the file.</summary>
        NS_E_WMP_CONVERT_PLUGIN_UNKNOWN_FILE_OWNER = unchecked((int)0xC00D115E),
        ...
        NS_E_DVD_DISC_COPY_PROTECT_OUTPUT_NS = unchecked((int)0xC00D1160),
        ...
        NS_E_DVD_DISC_COPY_PROTECT_OUTPUT_FAILED = unchecked((int)0xC00D1161),
        ...
        NS_E_DVD_NO_SUBPICTURE_STREAM = unchecked((int)0xC00D1162),
        ...
        NS_E_DVD_COPY_PROTECT = unchecked((int)0xC00D1163),
        ...
        NS_E_DVD_AUTHORING_PROBLEM = unchecked((int)0xC00D1164),
        ...
        NS_E_DVD_MACROVISION = unchecked((int)0xC00D1167),
        ...
        NS_E_DVD_SYSTEM_DECODER_REGION = unchecked((int)0xC00D1168),

        /// <summary>Windows Media Player cannot play the DVD because the disc prohibits playback in your region of the world. You must obtain a disc that is intended for your geographic region.</summary>
        NS_E_DVD_DISC_DECODER_REGION = unchecked((int)0xC00D1169),
        ...
        NS_E_DVD_NO_VIDEO_STREAM = unchecked((int)0xC00D116A),
        ...
        NS_E_DVD_NO_AUDIO_STREAM = unchecked((int)0xC00D116B),
        ...
        NS_E_DVD_GRAPH_BUILDING = unchecked((int)0xC00D116C),
        ...
        NS_E_DVD_NO_DECODER = unchecked((int)0xC00D116D),
        ...
        NS_E_DVD_PARENTAL = unchecked((int)0xC00D116E),

        /// <summary>Windows Media Player cannot skip to the requested location on the DVD.</summary>
        NS_E_DVD_CANNOT_JUMP = unchecked((int)0xC00D116F),
        ...
        NS_E_DVD_DEVICE_CONTENTION = unchecked((int)0xC00D1170),

        /// <summary>Windows Media Player cannot play DVD video. You might need to adjust your Windows display settings. Open display settings in Control Panel, and then try lowering your screen resolution and color quality settings.</summary>
        NS_E_DVD_NO_VIDEO_MEMORY = unchecked((int)0xC00D1171),

        /// <summary>Windows Media Player cannot rip the DVD because it is copy protected.</summary>
        NS_E_DVD_CANNOT_COPY_PROTECTED = unchecked((int)0xC00D1172),

        /// <summary>One of more of the required properties has not been set.</summary>
        NS_E_DVD_REQUIRED_PROPERTY_NOT_SET = unchecked((int)0xC00D1173),

        /// <summary>The specified title and/or chapter number does not exist on this DVD.</summary>
        NS_E_DVD_INVALID_TITLE_CHAPTER = unchecked((int)0xC00D1174),
        ...
        NS_E_NO_CD_BURNER = unchecked((int)0xC00D1176),
        ...
        NS_E_IMAPI_LOSSOFSTREAMING = unchecked((int)0xC00D117E),
        ...
        NS_E_PDA_DEVICE_FULL = unchecked((int)0xC00D117F),
        ...
        NS_E_FAIL_LAUNCH_ROXIO_PLUGIN = unchecked((int)0xC00D1180),
        ...
        NS_E_PDA_CANNOT_CREATE_ADDITIONAL_SYNC_RELATIONSHIP = unchecked((int)0xC00D1185),
        ...
        NS_E_PDA_NO_TRANSCODE_OF_DRM = unchecked((int)0xC00D1186),
        ...
        NS_E_PDA_TRANSCODECACHEFULL = unchecked((int)0xC00D1187),
        ...
        NS_E_PDA_TOO_MANY_FILE_COLLISIONS = unchecked((int)0xC00D1188),

        /// <summary>Windows Media Player cannot convert the file to the format required by the device.</summary>
        NS_E_PDA_CANNOT_TRANSCODE = unchecked((int)0xC00D1189),
        ...
        NS_E_PDA_TOO_MANY_FILES_IN_DIRECTORY = unchecked((int)0xC00D118A),

        /// <summary>Windows Media Player is already trying to start the Device Setup Wizard.</summary>
        NS_E_PROCESSINGSHOWSYNCWIZARD = unchecked((int)0xC00D118B),
        ...
        NS_E_PDA_TRANSCODE_NOT_PERMITTED = unchecked((int)0xC00D118C),

        /// <summary>Windows Media Player is busy setting up devices. Try again later.</summary>
        NS_E_PDA_INITIALIZINGDEVICES = unchecked((int)0xC00D118D),
        ...
        NS_E_PDA_OBSOLETE_SP = unchecked((int)0xC00D118E),
        ...
        NS_E_PDA_TITLE_COLLISION = unchecked((int)0xC00D118F),
        ...
        NS_E_PDA_DEVICESUPPORTDISABLED = unchecked((int)0xC00D1190),

        /// <summary>This device is not available. Connect the device to the computer, and then try again.</summary>
        NS_E_PDA_NO_LONGER_AVAILABLE = unchecked((int)0xC00D1191),
        ...
        NS_E_PDA_ENCODER_NOT_RESPONDING = unchecked((int)0xC00D1192),
        ...
        NS_E_PDA_CANNOT_SYNC_FROM_LOCATION = unchecked((int)0xC00D1193),
        ...
        NS_E_WMP_PROTOCOL_PROBLEM = unchecked((int)0xC00D1194),
        ...
        NS_E_WMP_CANNOT_FIND_FILE = unchecked((int)0xC00D1197),
        ...
        NS_E_WMP_SERVER_INACCESSIBLE = unchecked((int)0xC00D1198),
        ...
        NS_E_WMP_UNSUPPORTED_FORMAT = unchecked((int)0xC00D1199),
        ...
        NS_E_WMP_DSHOW_UNSUPPORTED_FORMAT = unchecked((int)0xC00D119A),
        ...
        NS_E_WMP_PLAYLIST_EXISTS = unchecked((int)0xC00D119B),
        ...
        NS_E_WMP_NONMEDIA_FILES = unchecked((int)0xC00D119C),
        ...
        NS_E_WMP_INVALID_ASX = unchecked((int)0xC00D119D),
        ...
        NS_E_WMP_ALREADY_IN_USE = unchecked((int)0xC00D119E),
        ...
        NS_E_WMP_IMAPI_FAILURE = unchecked((int)0xC00D119F),
        ...
        NS_E_WMP_WMDM_FAILURE = unchecked((int)0xC00D11A0),
        ...
        NS_E_WMP_CODEC_NEEDED_WITH_4CC = unchecked((int)0xC00D11A1),
        ...
        NS_E_WMP_CODEC_NEEDED_WITH_FORMATTAG = unchecked((int)0xC00D11A2),
        ...
        NS_E_WMP_MSSAP_NOT_AVAILABLE = unchecked((int)0xC00D11A3),
        ...
        NS_E_WMP_WMDM_LICENSE_NOTEXIST = unchecked((int)0xC00D11A6),
        ...
        NS_E_WMP_WMDM_LICENSE_EXPIRED = unchecked((int)0xC00D11A7),
        ...
        NS_E_WMP_WMDM_BUSY = unchecked((int)0xC00D11A8),
        ...
        NS_E_WMP_WMDM_NORIGHTS = unchecked((int)0xC00D11A9),
        ...
        NS_E_WMP_WMDM_INCORRECT_RIGHTS = unchecked((int)0xC00D11AA),
        ...
        NS_E_WMP_IMAPI_GENERIC = unchecked((int)0xC00D11AB),
        ...
        NS_E_WMP_IMAPI_DEVICE_NOTPRESENT = unchecked((int)0xC00D11AD),
        ...
        NS_E_WMP_IMAPI_DEVICE_BUSY = unchecked((int)0xC00D11AE),

        /// <summary>Windows Media Player cannot burn the files to the CD.</summary>
        NS_E_WMP_IMAPI_LOSS_OF_STREAMING = unchecked((int)0xC00D11AF),
        ...
        NS_E_WMP_SERVER_UNAVAILABLE = unchecked((int)0xC00D11B0),
        ...
        NS_E_WMP_FILE_OPEN_FAILED = unchecked((int)0xC00D11B1),
        ...
        NS_E_WMP_VERIFY_ONLINE = unchecked((int)0xC00D11B2),
        ...
        NS_E_WMP_SERVER_NOT_RESPONDING = unchecked((int)0xC00D11B3),
        ...
        NS_E_WMP_DRM_CORRUPT_BACKUP = unchecked((int)0xC00D11B4),
        ...
        NS_E_WMP_DRM_LICENSE_SERVER_UNAVAILABLE = unchecked((int)0xC00D11B5),
        ...
        NS_E_WMP_NETWORK_FIREWALL = unchecked((int)0xC00D11B6),

        /// <summary>Insert the removable media, and then try again.</summary>
        NS_E_WMP_NO_REMOVABLE_MEDIA = unchecked((int)0xC00D11B7),
        ...
        NS_E_WMP_PROXY_CONNECT_TIMEOUT = unchecked((int)0xC00D11B8),
        ...
        NS_E_WMP_NEED_UPGRADE = unchecked((int)0xC00D11B9),
        ...
        NS_E_WMP_AUDIO_HW_PROBLEM = unchecked((int)0xC00D11BA),
        ...
        NS_E_WMP_MMS_NOT_SUPPORTED = unchecked((int)0xC00D11BD),
        ...
        NS_E_WMP_NO_PROTOCOLS_SELECTED = unchecked((int)0xC00D11BE),
        ...
        NS_E_WMP_GOFULLSCREEN_FAILED = unchecked((int)0xC00D11BF),
        ...
        NS_E_WMP_NETWORK_ERROR = unchecked((int)0xC00D11C0),
        ...
        NS_E_WMP_CONNECT_TIMEOUT = unchecked((int)0xC00D11C1),
        ...
        NS_E_WMP_MULTICAST_DISABLED = unchecked((int)0xC00D11C2),
        ...
        NS_E_WMP_SERVER_DNS_TIMEOUT = unchecked((int)0xC00D11C3),
        ...
        NS_E_WMP_PROXY_NOT_FOUND = unchecked((int)0xC00D11C4),

        /// <summary>Windows Media Player cannot play the file because it is corrupted.</summary>
        NS_E_WMP_TAMPERED_CONTENT = unchecked((int)0xC00D11C5),

        /// <summary>Your computer is running low on memory. Quit other programs, and then try again.</summary>
        NS_E_WMP_OUTOFMEMORY = unchecked((int)0xC00D11C6),
        ...
        NS_E_WMP_AUDIO_CODEC_NOT_INSTALLED = unchecked((int)0xC00D11C7),
        ...
        NS_E_WMP_VIDEO_CODEC_NOT_INSTALLED = unchecked((int)0xC00D11C8),
        ...
        NS_E_WMP_IMAPI_DEVICE_INVALIDTYPE = unchecked((int)0xC00D11C9),
        ...
        NS_E_WMP_DRM_NEEDS_AUTHORIZATION = unchecked((int)0xC00D11D0),
        ...
        NS_E_WMP_BAD_DRIVER = unchecked((int)0xC00D11D1),
        ...
        NS_E_WMP_ACCESS_DENIED = unchecked((int)0xC00D11D2),
        ...
        NS_E_WMP_LICENSE_RESTRICTS = unchecked((int)0xC00D11D3),

        /// <summary>Windows Media Player cannot perform the requested action at this time.</summary>
        NS_E_WMP_INVALID_REQUEST = unchecked((int)0xC00D11D4),
        ...
        NS_E_WMP_CD_STASH_NO_SPACE = unchecked((int)0xC00D11D5),
        ...
        NS_E_WMP_DRM_NEW_HARDWARE = unchecked((int)0xC00D11D6),
        ...
        NS_E_WMP_BURN_DISC_OVERFLOW = unchecked((int)0xC00D11D9),
        ...
        NS_E_WMP_DRM_GENERIC_LICENSE_FAILURE = unchecked((int)0xC00D11DA),
        ...
        NS_E_WMP_DRM_NO_SECURE_CLOCK = unchecked((int)0xC00D11DB),
        ...
        NS_E_WMP_DRM_NO_RIGHTS = unchecked((int)0xC00D11DC),

        /// <summary>Windows Media Player encountered an error during upgrade.</summary>
        NS_E_WMP_DRM_INDIV_FAILED = unchecked((int)0xC00D11DD),
        ...
        NS_E_WMP_SERVER_NONEWCONNECTIONS = unchecked((int)0xC00D11DE),
        ...
        NS_E_WMP_MULTIPLE_ERROR_IN_PLAYLIST = unchecked((int)0xC00D11DF),
        ...
        NS_E_WMP_IMAPI2_ERASE_FAIL = unchecked((int)0xC00D11E0),
        ...
        NS_E_WMP_IMAPI2_ERASE_DEVICE_BUSY = unchecked((int)0xC00D11E1),
        ...
        NS_E_WMP_DRM_COMPONENT_FAILURE = unchecked((int)0xC00D11E2),
        ...
        NS_E_WMP_DRM_NO_DEVICE_CERT = unchecked((int)0xC00D11E3),
        ...
        NS_E_WMP_SERVER_SECURITY_ERROR = unchecked((int)0xC00D11E4),
        ...
        NS_E_WMP_AUDIO_DEVICE_LOST = unchecked((int)0xC00D11E5),
        ...
        NS_E_WMP_IMAPI_MEDIA_INCOMPATIBLE = unchecked((int)0xC00D11E6),
        ...
        NS_E_SYNCWIZ_DEVICE_FULL = unchecked((int)0xC00D11EE),

        /// <summary>It is not possible to change sync settings at this time. Try again later.</summary>
        NS_E_SYNCWIZ_CANNOT_CHANGE_SETTINGS = unchecked((int)0xC00D11EF),
        ...
        NS_E_TRANSCODE_DELETECACHEERROR = unchecked((int)0xC00D11F0),
        ...
        NS_E_CD_NO_BUFFERS_READ = unchecked((int)0xC00D11F8),

        /// <summary>No CD track was specified for playback.</summary>
        NS_E_CD_EMPTY_TRACK_QUEUE = unchecked((int)0xC00D11F9),

        /// <summary>The CD filter was not able to create the CD reader.</summary>
        NS_E_CD_NO_READER = unchecked((int)0xC00D11FA),

        /// <summary>Invalid ISRC code.</summary>
        NS_E_CD_ISRC_INVALID = unchecked((int)0xC00D11FB),

        /// <summary>Invalid Media Catalog Number.</summary>
        NS_E_CD_MEDIA_CATALOG_NUMBER_INVALID = unchecked((int)0xC00D11FC),
        ...
        NS_E_WMP_DRM_ACQUIRING_LICENSE = unchecked((int)0xC00D1202),
        ...
        NS_E_WMP_DRM_LICENSE_EXPIRED = unchecked((int)0xC00D1203),
        ...
        NS_E_WMP_DRM_LICENSE_NOTACQUIRED = unchecked((int)0xC00D1204),
        ...
        NS_E_WMP_DRM_LICENSE_NOTENABLED = unchecked((int)0xC00D1205),
        ...
        NS_E_WMP_DRM_LICENSE_UNUSABLE = unchecked((int)0xC00D1206),
        ...
        NS_E_WMP_DRM_LICENSE_CONTENT_REVOKED = unchecked((int)0xC00D1207),
        ...
        NS_E_WMP_DRM_LICENSE_NOSAP = unchecked((int)0xC00D1208),

        /// <summary>Windows Media Player cannot download media usage rights at this time. Try again later.</summary>
        NS_E_WMP_DRM_UNABLE_TO_ACQUIRE_LICENSE = unchecked((int)0xC00D1209),
        ...
        NS_E_WMP_LICENSE_REQUIRED = unchecked((int)0xC00D120A),

        /// <summary>Windows Media Player cannot play, burn, or sync the file because the media usage rights are missing. If you obtained the file from an online store, sign in to the store, and then try again.</summary>
        NS_E_WMP_PROTECTED_CONTENT = unchecked((int)0xC00D120B),
        ...
        NS_E_WMP_POLICY_VALUE_NOT_CONFIGURED = unchecked((int)0xC00D122A),
        ...
        NS_E_PDA_CANNOT_SYNC_FROM_INTERNET = unchecked((int)0xC00D1234),
        ...
        NS_E_PDA_CANNOT_SYNC_INVALID_PLAYLIST = unchecked((int)0xC00D1235),
        ...
        NS_E_PDA_DEVICE_NOT_RESPONDING = unchecked((int)0xC00D123A),
        ...
        NS_E_PDA_FAILED_TO_TRANSCODE_PHOTO = unchecked((int)0xC00D123B),
        ...
        NS_E_PDA_FAILED_TO_ENCRYPT_TRANSCODED_FILE = unchecked((int)0xC00D123C),
        ...
        NS_E_PDA_CANNOT_TRANSCODE_TO_AUDIO = unchecked((int)0xC00D123D),
        ...
        NS_E_PDA_CANNOT_TRANSCODE_TO_VIDEO = unchecked((int)0xC00D123E),
        ...
        NS_E_PDA_CANNOT_TRANSCODE_TO_IMAGE = unchecked((int)0xC00D123F),
        ...
        NS_E_PDA_RETRIEVED_FILE_FILENAME_TOO_LONG = unchecked((int)0xC00D1240),
        ...
        NS_E_PDA_CEWMDM_DRM_ERROR = unchecked((int)0xC00D1241),

        /// <summary>Incomplete playlist.</summary>
        NS_E_INCOMPLETE_PLAYLIST = unchecked((int)0xC00D1242),
        ...
        NS_E_PDA_SYNC_RUNNING = unchecked((int)0xC00D1243),
        ...
        NS_E_PDA_SYNC_LOGIN_ERROR = unchecked((int)0xC00D1244),
        ...
        NS_E_PDA_TRANSCODE_CODEC_NOT_FOUND = unchecked((int)0xC00D1245),

        /// <summary>It is not possible to sync subscription files to this device.</summary>
        NS_E_CANNOT_SYNC_DRM_TO_NON_JANUS_DEVICE = unchecked((int)0xC00D1246),
        ...
        NS_E_CANNOT_SYNC_PREVIOUS_SYNC_RUNNING = unchecked((int)0xC00D1247),
        ...
        NS_E_WMP_HWND_NOTFOUND = unchecked((int)0xC00D125C),
        ...
        NS_E_BKGDOWNLOAD_WRONG_NO_FILES = unchecked((int)0xC00D125D),
        ...
        NS_E_BKGDOWNLOAD_FAILED_TO_CREATE_TEMPFILE = unchecked((int)0xC00D1262),
        ...
        NS_E_BKGDOWNLOAD_PLUGIN_FAILEDINITIALIZE = unchecked((int)0xC00D1263),

        /// <summary>The Windows Media Player download manager cannot move the file.</summary>
        NS_E_BKGDOWNLOAD_PLUGIN_FAILEDTOMOVEFILE = unchecked((int)0xC00D1264),
        ...
        NS_E_BKGDOWNLOAD_CALLFUNCENDED = unchecked((int)0xC00D1267),
        ...
        NS_E_BKGDOWNLOAD_WMDUNPACKFAILED = unchecked((int)0xC00D1268),
        ...
        NS_E_BKGDOWNLOAD_FAILEDINITIALIZE = unchecked((int)0xC00D1269),
        ...
        NS_E_INTERFACE_NOT_REGISTERED_IN_GIT = unchecked((int)0xC00D126A),
        ...
        NS_E_BKGDOWNLOAD_INVALID_FILE_NAME = unchecked((int)0xC00D126B),

        /// <summary>Windows Media Player encountered an error while downloading an image.</summary>
        NS_E_IMAGE_DOWNLOAD_FAILED = unchecked((int)0xC00D128E),
        ...
        NS_E_WMP_UDRM_NOUSERLIST = unchecked((int)0xC00D12C0),
        ...
        NS_E_WMP_DRM_NOT_ACQUIRING = unchecked((int)0xC00D12C1),

        /// <summary>The parameter is not valid.</summary>
        NS_E_WMP_BSTR_TOO_LONG = unchecked((int)0xC00D12F2),

        /// <summary>The state is not valid for this request.</summary>
        NS_E_WMP_AUTOPLAY_INVALID_STATE = unchecked((int)0xC00D12FC),
        ...
        NS_E_SUBSCRIPTIONSERVICE_LOGIN_FAILED = unchecked((int)0xC00D135F),
        ...
        NS_E_SUBSCRIPTIONSERVICE_DOWNLOAD_TIMEOUT = unchecked((int)0xC00D1360),

        /// <summary>Content Partner still initializing.</summary>
        NS_E_CONTENT_PARTNER_STILL_INITIALIZING = unchecked((int)0xC00D1362),

        /// <summary>The folder could not be opened. The folder might have been moved or deleted.</summary>
        NS_E_OPEN_CONTAINING_FOLDER_FAILED = unchecked((int)0xC00D1363),
        ...
        NS_E_INVALID_PUSH_PUBLISHING_POINT_START_REQUEST = unchecked((int)0xC00D145B),

        /// <summary>The specified language is not supported.</summary>
        NS_E_UNSUPPORTED_LANGUAGE = unchecked((int)0xC00D145C),
        ...
        NS_E_CRITICAL_ERROR = unchecked((int)0xC00D151C),
        ...
        NS_E_MEDIA_PARSER_INVALID_FORMAT = unchecked((int)0xC00D1581),
        ...
        NS_E_SCRIPT_DEBUGGER_NOT_INSTALLED = unchecked((int)0xC00D1582),

        /// <summary>The plug-in cannot be loaded because it requires Windows Server 2003, Enterprise Edition.</summary>
        NS_E_FEATURE_REQUIRES_ENTERPRISE_SERVER = unchecked((int)0xC00D1583),
        ...
        NS_E_PORT_IN_USE = unchecked((int)0xC00D158A),
        ...
        NS_E_INTERLACE_REQUIRE_SAMESIZE = unchecked((int)0xC00D1B95),

        /// <summary>Only one device control plug-in can control a device.</summary>
        NS_E_TOO_MANY_DEVICECONTROL = unchecked((int)0xC00D1B96),
        ...
        NS_E_CANNOT_GENERATE_BROADCAST_INFO_FOR_QUALITYVBR = unchecked((int)0xC00D1BDF),
        ...
        NS_E_TRANSFORM_PLUGIN_INVALID = unchecked((int)0xC00D1BE6),
        ...
        NS_E_DRM_INVALID_MACHINE = unchecked((int)0xC00D2719),

        /// <summary>License storage is not working. Contact Microsoft product support.</summary>
        NS_E_DRM_ENUM_LICENSE_FAILED = unchecked((int)0xC00D271B),

        /// <summary>The media file is corrupted. Contact the content provider to get a new file.</summary>
        NS_E_DRM_INVALID_LICENSE_REQUEST = unchecked((int)0xC00D271C),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_INITIALIZE = unchecked((int)0xC00D271D),

        /// <summary>The license could not be acquired. Try again later.</summary>
        NS_E_DRM_UNABLE_TO_ACQUIRE_LICENSE = unchecked((int)0xC00D271E),

        /// <summary>License acquisition did not work. Acquire a new license or contact the content provider for further assistance.</summary>
        NS_E_DRM_INVALID_LICENSE_ACQUIRED = unchecked((int)0xC00D271F),

        /// <summary>The requested operation cannot be performed on this file.</summary>
        NS_E_DRM_NO_RIGHTS = unchecked((int)0xC00D2720),
        ...
        NS_E_DRM_KEY_ERROR = unchecked((int)0xC00D2721),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_ENCRYPT_ERROR = unchecked((int)0xC00D2722),

        /// <summary>The media file is corrupted. Contact the content provider to get a new file.</summary>
        NS_E_DRM_DECRYPT_ERROR = unchecked((int)0xC00D2723),

        /// <summary>The license is corrupted. Acquire a new license.</summary>
        NS_E_DRM_LICENSE_INVALID_XML = unchecked((int)0xC00D2725),

        /// <summary>A security upgrade is required to perform the operation on this media file.</summary>
        NS_E_DRM_NEEDS_INDIVIDUALIZATION = unchecked((int)0xC00D2728),

        /// <summary>You already have the latest security components. No upgrade is necessary at this time.</summary>
        NS_E_DRM_ALREADY_INDIVIDUALIZED = unchecked((int)0xC00D2729),

        /// <summary>The application cannot perform this action. Contact product support for this application.</summary>
        NS_E_DRM_ACTION_NOT_QUERIED = unchecked((int)0xC00D272A),

        /// <summary>You cannot begin a new license acquisition process until the current one has been completed.</summary>
        NS_E_DRM_ACQUIRING_LICENSE = unchecked((int)0xC00D272B),

        /// <summary>You cannot begin a new security upgrade until the current one has been completed.</summary>
        NS_E_DRM_INDIVIDUALIZING = unchecked((int)0xC00D272C),

        /// <summary>Failure in Backup-Restore.</summary>
        NS_E_BACKUP_RESTORE_FAILURE = unchecked((int)0xC00D272D),

        /// <summary>Bad Request ID in Backup-Restore.</summary>
        NS_E_BACKUP_RESTORE_BAD_REQUEST_ID = unchecked((int)0xC00D272E),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_PARAMETERS_MISMATCHED = unchecked((int)0xC00D272F),

        /// <summary>A license cannot be created for this media file. Reinstall the application.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_LICENSE_OBJECT = unchecked((int)0xC00D2730),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_INDI_OBJECT = unchecked((int)0xC00D2731),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_ENCRYPT_OBJECT = unchecked((int)0xC00D2732),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_DECRYPT_OBJECT = unchecked((int)0xC00D2733),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_PROPERTIES_OBJECT = unchecked((int)0xC00D2734),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_BACKUP_OBJECT = unchecked((int)0xC00D2735),

        /// <summary>The security upgrade failed. Try again later.</summary>
        NS_E_DRM_INDIVIDUALIZE_ERROR = unchecked((int)0xC00D2736),

        /// <summary>License storage is not working. Contact Microsoft product support.</summary>
        NS_E_DRM_LICENSE_OPEN_ERROR = unchecked((int)0xC00D2737),

        /// <summary>License storage is not working. Contact Microsoft product support.</summary>
        NS_E_DRM_LICENSE_CLOSE_ERROR = unchecked((int)0xC00D2738),

        /// <summary>License storage is not working. Contact Microsoft product support.</summary>
        NS_E_DRM_GET_LICENSE_ERROR = unchecked((int)0xC00D2739),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_QUERY_ERROR = unchecked((int)0xC00D273A),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact product support for this application.</summary>
        NS_E_DRM_REPORT_ERROR = unchecked((int)0xC00D273B),

        /// <summary>License storage is not working. Contact Microsoft product support.</summary>
        NS_E_DRM_GET_LICENSESTRING_ERROR = unchecked((int)0xC00D273C),

        /// <summary>The media file is corrupted. Contact the content provider to get a new file.</summary>
        NS_E_DRM_GET_CONTENTSTRING_ERROR = unchecked((int)0xC00D273D),

        /// <summary>A problem has occurred in the Digital Rights Management component. Try again later.</summary>
        NS_E_DRM_MONITOR_ERROR = unchecked((int)0xC00D273E),
        ...
        NS_E_DRM_SECURE_STORE_NOT_FOUND = unchecked((int)0xC00D274A),
        ...
        NS_E_DRM_CACHED_CONTENT_ERROR = unchecked((int)0xC00D274B),

        /// <summary>A problem occurred during the security upgrade. Try again later.</summary>
        NS_E_DRM_INDIVIDUALIZATION_INCOMPLETE = unchecked((int)0xC00D274C),
        ...
        NS_E_DRM_DRIVER_AUTH_FAILURE = unchecked((int)0xC00D274D),
        ...
        NS_E_DRM_NEED_UPGRADE_MSSAP = unchecked((int)0xC00D274E),

        /// <summary>Status message: Reopen the file.</summary>
        NS_E_DRM_REOPEN_CONTENT = unchecked((int)0xC00D274F),
        ...
        NS_E_DRM_DRIVER_DIGIOUT_FAILURE = unchecked((int)0xC00D2750),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_INVALID_SECURESTORE_PASSWORD = unchecked((int)0xC00D2751),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_APPCERT_REVOKED = unchecked((int)0xC00D2752),

        /// <summary>You cannot restore your license(s).</summary>
        NS_E_DRM_RESTORE_FRAUD = unchecked((int)0xC00D2753),

        /// <summary>The licenses for your media files are corrupted. Contact Microsoft product support.</summary>
        NS_E_DRM_HARDWARE_INCONSISTENT = unchecked((int)0xC00D2754),

        /// <summary>To transfer this media file, you must upgrade the application.</summary>
        NS_E_DRM_SDMI_TRIGGER = unchecked((int)0xC00D2755),

        /// <summary>You cannot make any more copies of this media file.</summary>
        NS_E_DRM_SDMI_NOMORECOPIES = unchecked((int)0xC00D2756),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_HEADER_OBJECT = unchecked((int)0xC00D2757),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_KEYS_OBJECT = unchecked((int)0xC00D2758),

        /// <summary>Unable to obtain license.</summary>
        NS_E_DRM_LICENSE_NOTACQUIRED = unchecked((int)0xC00D2759),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_CODING_OBJECT = unchecked((int)0xC00D275A),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_STATE_DATA_OBJECT = unchecked((int)0xC00D275B),

        /// <summary>The buffer supplied is not sufficient.</summary>
        NS_E_DRM_BUFFER_TOO_SMALL = unchecked((int)0xC00D275C),

        /// <summary>The property requested is not supported.</summary>
        NS_E_DRM_UNSUPPORTED_PROPERTY = unchecked((int)0xC00D275D),

        /// <summary>The specified server cannot perform the requested operation.</summary>
        NS_E_DRM_ERROR_BAD_NET_RESP = unchecked((int)0xC00D275E),

        /// <summary>Some of the licenses could not be stored.</summary>
        NS_E_DRM_STORE_NOTALLSTORED = unchecked((int)0xC00D275F),
        ...
        NS_E_DRM_SECURITY_COMPONENT_SIGNATURE_INVALID = unchecked((int)0xC00D2760),

        /// <summary>Invalid or corrupt data was encountered.</summary>
        NS_E_DRM_INVALID_DATA = unchecked((int)0xC00D2761),
        ...
        NS_E_DRM_POLICY_DISABLE_ONLINE = unchecked((int)0xC00D2762),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_AUTHENTICATION_OBJECT = unchecked((int)0xC00D2763),

        /// <summary>Not all of the necessary properties for DRM have been set.</summary>
        NS_E_DRM_NOT_CONFIGURED = unchecked((int)0xC00D2764),
        ...
        NS_E_DRM_DEVICE_ACTIVATION_CANCELED = unchecked((int)0xC00D2765),

        /// <summary>Too many resets in Backup-Restore.</summary>
        NS_E_BACKUP_RESTORE_TOO_MANY_RESETS = unchecked((int)0xC00D2766),

        /// <summary>Running this process under a debugger while using DRM content is not allowed.</summary>
        NS_E_DRM_DEBUGGING_NOT_ALLOWED = unchecked((int)0xC00D2767),

        /// <summary>The user canceled the DRM operation.</summary>
        NS_E_DRM_OPERATION_CANCELED = unchecked((int)0xC00D2768),
        ...
        NS_E_DRM_UNABLE_TO_LOAD_HARDWARE_ID = unchecked((int)0xC00D2781),
        ...
        NS_E_DRM_UNABLE_TO_OPEN_DATA_STORE = unchecked((int)0xC00D2782),

        /// <summary>The Digital Rights Management data storage is not functioning properly. Contact Microsoft product support.</summary>
        NS_E_DRM_DATASTORE_CORRUPT = unchecked((int)0xC00D2783),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_INMEMORYSTORE_OBJECT = unchecked((int)0xC00D2784),

        /// <summary>A secured library is required to access the requested functionality.</summary>
        NS_E_DRM_STUBLIB_REQUIRED = unchecked((int)0xC00D2785),

        /// <summary>A problem has occurred in the Digital Rights Management component. Contact Microsoft product support.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_CERTIFICATE_OBJECT = unchecked((int)0xC00D2786),
        ...
        NS_E_DRM_MIGRATION_TARGET_NOT_ONLINE = unchecked((int)0xC00D2787),

        /// <summary>A problem has occurred in the Digital Rights Management component during license migration. Contact Microsoft product support.</summary>
        NS_E_DRM_INVALID_MIGRATION_IMAGE = unchecked((int)0xC00D2788),

        /// <summary>A problem has occurred in the Digital Rights Management component during license migration. Contact Microsoft product support.</summary>
        NS_E_DRM_MIGRATION_TARGET_STATES_CORRUPTED = unchecked((int)0xC00D2789),

        /// <summary>A problem has occurred in the Digital Rights Management component during license migration. Contact Microsoft product support.</summary>
        NS_E_DRM_MIGRATION_IMPORTER_NOT_AVAILABLE = unchecked((int)0xC00D278A),

        /// <summary>A problem has occurred in the Digital Rights Management component during license migration. Contact Microsoft product support.</summary>
        NS_DRM_E_MIGRATION_UPGRADE_WITH_DIFF_SID = unchecked((int)0xC00D278B),
        ...
        NS_DRM_E_MIGRATION_SOURCE_MACHINE_IN_USE = unchecked((int)0xC00D278C),
        ...
        NS_DRM_E_MIGRATION_TARGET_MACHINE_LESS_THAN_LH = unchecked((int)0xC00D278D),

        /// <summary>Migration Image already exists. Contact Microsoft product support.</summary>
        NS_DRM_E_MIGRATION_IMAGE_ALREADY_EXISTS = unchecked((int)0xC00D278E),
        ...
        NS_E_DRM_HARDWAREID_MISMATCH = unchecked((int)0xC00D278F),

        /// <summary>The wrong stublib has been linked to an application or DLL using drmv2clt.dll.</summary>
        NS_E_INVALID_DRMV2CLT_STUBLIB = unchecked((int)0xC00D2790),

        /// <summary>The legacy V2 data being imported is invalid.</summary>
        NS_E_DRM_MIGRATION_INVALID_LEGACYV2_DATA = unchecked((int)0xC00D2791),

        /// <summary>The license being imported already exists.</summary>
        NS_E_DRM_MIGRATION_LICENSE_ALREADY_EXISTS = unchecked((int)0xC00D2792),

        /// <summary>The password of the Legacy V2 SST entry being imported is incorrect.</summary>
        NS_E_DRM_MIGRATION_INVALID_LEGACYV2_SST_PASSWORD = unchecked((int)0xC00D2793),

        /// <summary>Migration is not supported by the plugin.</summary>
        NS_E_DRM_MIGRATION_NOT_SUPPORTED = unchecked((int)0xC00D2794),

        /// <summary>A migration importer cannot be created for this media file. Reinstall the application.</summary>
        NS_E_DRM_UNABLE_TO_CREATE_MIGRATION_IMPORTER_OBJECT = unchecked((int)0xC00D2795),

        /// <summary>The requested action cannot be performed because a problem occurred with the Windows Media Digital Rights Management (DRM) components on your computer.</summary>
        NS_E_DRM_CHECKPOINT_MISMATCH = unchecked((int)0xC00D2796),

        /// <summary>The requested action cannot be performed because a problem occurred with the Windows Media Digital Rights Management (DRM) components on your computer.</summary>
        NS_E_DRM_CHECKPOINT_CORRUPT = unchecked((int)0xC00D2797),

        /// <summary>The requested action cannot be performed because a problem occurred with the Windows Media Digital Rights Management (DRM) components on your computer.</summary>
        NS_E_REG_FLUSH_FAILURE = unchecked((int)0xC00D2798),

        /// <summary>The requested action cannot be performed because a problem occurred with the Windows Media Digital Rights Management (DRM) components on your computer.</summary>
        NS_E_HDS_KEY_MISMATCH = unchecked((int)0xC00D2799),

        /// <summary>Migration was canceled by the user.</summary>
        NS_E_DRM_MIGRATION_OPERATION_CANCELLED = unchecked((int)0xC00D279A),

        /// <summary>Migration object is already in use and cannot be called until the current operation completes.</summary>
        NS_E_DRM_MIGRATION_OBJECT_IN_USE = unchecked((int)0xC00D279B),

        /// <summary>The content header does not comply with DRM requirements and cannot be used.</summary>
        NS_E_DRM_MALFORMED_CONTENT_HEADER = unchecked((int)0xC00D279C),
        ...
        NS_E_DRM_LICENSE_EXPIRED = unchecked((int)0xC00D27D8),

        /// <summary>The license for this file is not valid yet, but will be at a future date.</summary>
        NS_E_DRM_LICENSE_NOTENABLED = unchecked((int)0xC00D27D9),
        ...
        NS_E_DRM_LICENSE_CERT_EXPIRED = unchecked((int)0xC00D27DF),

        /// <summary>The license for this file requires a higher level of security than the player you are currently using has. Try using a different player or download a newer version of your current player.</summary>
        NS_E_DRM_LICENSE_SECLOW = unchecked((int)0xC00D27E0),
        ...
        NS_E_DRM_LICENSE_CONTENT_REVOKED = unchecked((int)0xC00D27E1),
        ...
        NS_E_DRM_DEVICE_NOT_REGISTERED = unchecked((int)0xC00D27E2),
        ...
        NS_E_DRM_LICENSE_NOSAP = unchecked((int)0xC00D280A),

        /// <summary>The license for this file requires a feature that is not supported in your current player or operating system. You can try with newer version of your current player or contact your content provider for further assistance.</summary>
        NS_E_DRM_LICENSE_NOSVP = unchecked((int)0xC00D280B),
        ...
        NS_E_DRM_LICENSE_NOWDM = unchecked((int)0xC00D280C),

        /// <summary>The license for this file requires a higher level of security than the player you are currently using has. Try using a different player or download a newer version of your current player.</summary>
        NS_E_DRM_LICENSE_NOTRUSTEDCODEC = unchecked((int)0xC00D280D),
        ...
        NS_E_DRM_SOURCEID_NOT_SUPPORTED = unchecked((int)0xC00D280E),

        /// <summary>An updated version of your media player is required to play the selected content.</summary>
        NS_E_DRM_NEEDS_UPGRADE_TEMPFILE = unchecked((int)0xC00D283D),
        ...
        NS_E_DRM_INDIV_FRAUD = unchecked((int)0xC00D2843),
        ...
        NS_E_CONNECT_TIMEOUT = unchecked((int)0xC00D2F06),
        ...
        NS_E_PROXY_CONNECT_TIMEOUT = unchecked((int)0xC00D2F07),

        /// <summary>Session not found.</summary>
        NS_E_SESSION_INVALID = unchecked((int)0xC00D2F08),

        /// <summary>Unknown packet sink stream.</summary>
        NS_E_PACKETSINK_UNKNOWN_FEC_STREAM = unchecked((int)0xC00D2F0A),
        ...
        NS_E_PUSH_CANNOTCONNECT = unchecked((int)0xC00D2F0B),
        ...
        NS_E_INCOMPATIBLE_PUSH_SERVER = unchecked((int)0xC00D2F0C),

        /// <summary>The playlist has reached its end.</summary>
        NS_E_END_OF_PLAYLIST = unchecked((int)0xC00D32C8),

        /// <summary>Use file source.</summary>
        NS_E_USE_FILE_SOURCE = unchecked((int)0xC00D32C9),

        /// <summary>The property was not found.</summary>
        NS_E_PROPERTY_NOT_FOUND = unchecked((int)0xC00D32CA),

        /// <summary>The property is read only.</summary>
        NS_E_PROPERTY_READ_ONLY = unchecked((int)0xC00D32CC),

        /// <summary>The table key was not found.</summary>
        NS_E_TABLE_KEY_NOT_FOUND = unchecked((int)0xC00D32CD),

        /// <summary>Invalid query operator.</summary>
        NS_E_INVALID_QUERY_OPERATOR = unchecked((int)0xC00D32CF),

        /// <summary>Invalid query property.</summary>
        NS_E_INVALID_QUERY_PROPERTY = unchecked((int)0xC00D32D0),

        /// <summary>The property is not supported.</summary>
        NS_E_PROPERTY_NOT_SUPPORTED = unchecked((int)0xC00D32D2),

        /// <summary>Schema classification failure.</summary>
        NS_E_SCHEMA_CLASSIFY_FAILURE = unchecked((int)0xC00D32D4),

        /// <summary>The metadata format is not supported.</summary>
        NS_E_METADATA_FORMAT_NOT_SUPPORTED = unchecked((int)0xC00D32D5),

        /// <summary>Cannot edit the metadata.</summary>
        NS_E_METADATA_NO_EDITING_CAPABILITY = unchecked((int)0xC00D32D6),

        /// <summary>Cannot set the locale id.</summary>
        NS_E_METADATA_CANNOT_SET_LOCALE = unchecked((int)0xC00D32D7),

        /// <summary>The language is not supported in the format.</summary>
        NS_E_METADATA_LANGUAGE_NOT_SUPORTED = unchecked((int)0xC00D32D8),

        /// <summary>There is no RFC1766 name translation for the supplied locale id.</summary>
        NS_E_METADATA_NO_RFC1766_NAME_FOR_LOCALE = unchecked((int)0xC00D32D9),

        /// <summary>The metadata (or metadata item) is not available.</summary>
        NS_E_METADATA_NOT_AVAILABLE = unchecked((int)0xC00D32DA),

        /// <summary>The cached metadata (or metadata item) is not available.</summary>
        NS_E_METADATA_CACHE_DATA_NOT_AVAILABLE = unchecked((int)0xC00D32DB),

        /// <summary>The metadata document is invalid.</summary>
        NS_E_METADATA_INVALID_DOCUMENT_TYPE = unchecked((int)0xC00D32DC),

        /// <summary>The metadata content identifier is not available.</summary>
        NS_E_METADATA_IDENTIFIER_NOT_AVAILABLE = unchecked((int)0xC00D32DD),

        /// <summary>Cannot retrieve metadata from the offline metadata cache.</summary>
        NS_E_METADATA_CANNOT_RETRIEVE_FROM_OFFLINE_CACHE = unchecked((int)0xC00D32DE),
        ...
        ERROR_GRAPHICS_OPM_PARAMETER_ARRAY_TOO_SMALL = unchecked((int)0xC0262504),
        ...
        ERROR_GRAPHICS_PVP_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME = unchecked((int)0xC0262506),

        /// <summary>This function failed because the GDI display device passed to it was not attached to the Windows desktop.</summary>
        ERROR_GRAPHICS_PVP_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP = unchecked((int)0xC0262507),

        /// <summary>The PVP does not support mirroring display devices because they do not have video outputs.</summary>
        ERROR_GRAPHICS_PVP_MIRRORING_DEVICES_NOT_SUPPORTED = unchecked((int)0xC0262508),
        ...
        ERROR_GRAPHICS_OPM_INVALID_POINTER = unchecked((int)0xC026250A),
        ...
        ERROR_GRAPHICS_PVP_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE = unchecked((int)0xC026250D),
        ...
        ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_NO_LONGER_EXISTS = unchecked((int)0xC0262519),
        ...
        ERROR_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS = unchecked((int)0xC026251A),
        ...
        ERROR_GRAPHICS_PMEA_INVALID_MONITOR = unchecked((int)0xC02625D6),
        ...
        ERROR_GRAPHICS_PMEA_INVALID_D3D_DEVICE = unchecked((int)0xC02625D7),
