namespace Microsoft.Win32.WindowsProtocols.MsErrRef
{
    ...
    public enum NTSTATUS : int
    {
        ...
        /// </summary>
        STATUS_PKU2U_CERT_FAILURE = unchecked((int)0xC000042E),
        ...
        /// <summary>
        /// Offload read operations cannot be performed on:<br/>
        /// ◾Compressed files<br/>
        /// ◾Sparse files<br/>
        /// ◾Encrypted files<br/>
        /// ◾File system metadata files<br/>
        /// </summary>
        ...
        /// </summary>
        DBG_NO_STATE_CHANGE = unchecked((int)0xC0010001),

        /// <summary>
        /// The debugger found that the application is not idle.
        /// </summary>
        DBG_APP_NOT_IDLE = unchecked((int)0xC0010002),

        /// <summary>
        /// The string binding is invalid.
        /// </summary>
        RPC_NT_INVALID_STRING_BINDING = unchecked((int)0xC0020001),

        /// <summary>
        /// The binding handle is not the correct type.
        /// </summary>
        RPC_NT_WRONG_KIND_OF_BINDING = unchecked((int)0xC0020002),

        /// <summary>
        /// The binding handle is invalid.
        /// </summary>
        RPC_NT_INVALID_BINDING = unchecked((int)0xC0020003),

        /// <summary>
        /// The RPC protocol sequence is not supported.
        /// </summary>
        RPC_NT_PROTSEQ_NOT_SUPPORTED = unchecked((int)0xC0020004),

        /// <summary>
        /// The RPC protocol sequence is invalid.
        /// </summary>
        RPC_NT_INVALID_RPC_PROTSEQ = unchecked((int)0xC0020005),

        /// <summary>
        /// The string UUID is invalid.
        /// </summary>
        RPC_NT_INVALID_STRING_UUID = unchecked((int)0xC0020006),

        /// <summary>
        /// The endpoint format is invalid.
        /// </summary>
        RPC_NT_INVALID_ENDPOINT_FORMAT = unchecked((int)0xC0020007),

        /// <summary>
        /// The network address is invalid.
        /// </summary>
        RPC_NT_INVALID_NET_ADDR = unchecked((int)0xC0020008),

        /// <summary>
        /// No endpoint was found.
        /// </summary>
        RPC_NT_NO_ENDPOINT_FOUND = unchecked((int)0xC0020009),

        /// <summary>
        /// The time-out value is invalid.
        /// </summary>
        RPC_NT_INVALID_TIMEOUT = unchecked((int)0xC002000A),

        /// <summary>
        /// The object UUID was not found.
        /// </summary>
        RPC_NT_OBJECT_NOT_FOUND = unchecked((int)0xC002000B),

        /// <summary>
        /// The object UUID has already been registered.
        /// </summary>
        RPC_NT_ALREADY_REGISTERED = unchecked((int)0xC002000C),

        /// <summary>
        /// The type UUID has already been registered.
        /// </summary>
        RPC_NT_TYPE_ALREADY_REGISTERED = unchecked((int)0xC002000D),

        /// <summary>
        /// The RPC server is already listening.
        /// </summary>
        RPC_NT_ALREADY_LISTENING = unchecked((int)0xC002000E),

        /// <summary>
        /// No protocol sequences have been registered.
        /// </summary>
        RPC_NT_NO_PROTSEQS_REGISTERED = unchecked((int)0xC002000F),

        /// <summary>
        /// The RPC server is not listening.
        /// </summary>
        RPC_NT_NOT_LISTENING = unchecked((int)0xC0020010),

        /// <summary>
        /// The manager type is unknown.
        /// </summary>
        RPC_NT_UNKNOWN_MGR_TYPE = unchecked((int)0xC0020011),

        /// <summary>
        /// The interface is unknown.
        /// </summary>
        RPC_NT_UNKNOWN_IF = unchecked((int)0xC0020012),

        /// <summary>
        /// There are no bindings.
        /// </summary>
        RPC_NT_NO_BINDINGS = unchecked((int)0xC0020013),

        /// <summary>
        /// There are no protocol sequences.
        /// </summary>
        RPC_NT_NO_PROTSEQS = unchecked((int)0xC0020014),

        /// <summary>
        /// The endpoint cannot be created.
        /// </summary>
        RPC_NT_CANT_CREATE_ENDPOINT = unchecked((int)0xC0020015),

        /// <summary>
        /// Insufficient resources are available to complete this operation.
        /// </summary>
        RPC_NT_OUT_OF_RESOURCES = unchecked((int)0xC0020016),

        /// <summary>
        /// The RPC server is unavailable.
        /// </summary>
        RPC_NT_SERVER_UNAVAILABLE = unchecked((int)0xC0020017),

        /// <summary>
        /// The RPC server is too busy to complete this operation.
        /// </summary>
        RPC_NT_SERVER_TOO_BUSY = unchecked((int)0xC0020018),

        /// <summary>
        /// The network options are invalid.
        /// </summary>
        RPC_NT_INVALID_NETWORK_OPTIONS = unchecked((int)0xC0020019),

        /// <summary>
        /// No RPCs are active on this thread.
        /// </summary>
        RPC_NT_NO_CALL_ACTIVE = unchecked((int)0xC002001A),

        /// <summary>
        /// The RPC failed.
        /// </summary>
        RPC_NT_CALL_FAILED = unchecked((int)0xC002001B),

        /// <summary>
        /// The RPC failed and did not execute.
        /// </summary>
        RPC_NT_CALL_FAILED_DNE = unchecked((int)0xC002001C),

        /// <summary>
        /// An RPC protocol error occurred.
        /// </summary>
        RPC_NT_PROTOCOL_ERROR = unchecked((int)0xC002001D),

        /// <summary>
        /// The RPC server does not support the transfer syntax.
        /// </summary>
        RPC_NT_UNSUPPORTED_TRANS_SYN = unchecked((int)0xC002001F),

        /// <summary>
        /// The type UUID is not supported.
        /// </summary>
        RPC_NT_UNSUPPORTED_TYPE = unchecked((int)0xC0020021),

        /// <summary>
        /// The tag is invalid.
        /// </summary>
        RPC_NT_INVALID_TAG = unchecked((int)0xC0020022),

        /// <summary>
        /// The array bounds are invalid.
        /// </summary>
        RPC_NT_INVALID_BOUND = unchecked((int)0xC0020023),

        /// <summary>
        /// The binding does not contain an entry name.
        /// </summary>
        RPC_NT_NO_ENTRY_NAME = unchecked((int)0xC0020024),

        /// <summary>
        /// The name syntax is invalid.
        /// </summary>
        RPC_NT_INVALID_NAME_SYNTAX = unchecked((int)0xC0020025),

        /// <summary>
        /// The name syntax is not supported.
        /// </summary>
        RPC_NT_UNSUPPORTED_NAME_SYNTAX = unchecked((int)0xC0020026),

        /// <summary>
        /// No network address is available to construct a UUID.
        /// </summary>
        RPC_NT_UUID_NO_ADDRESS = unchecked((int)0xC0020028),

        /// <summary>
        /// The endpoint is a duplicate.
        /// </summary>
        RPC_NT_DUPLICATE_ENDPOINT = unchecked((int)0xC0020029),

        /// <summary>
        /// The authentication type is unknown.
        /// </summary>
        RPC_NT_UNKNOWN_AUTHN_TYPE = unchecked((int)0xC002002A),

        /// <summary>
        /// The maximum number of calls is too small.
        /// </summary>
        RPC_NT_MAX_CALLS_TOO_SMALL = unchecked((int)0xC002002B),

        /// <summary>
        /// The string is too long.
        /// </summary>
        RPC_NT_STRING_TOO_LONG = unchecked((int)0xC002002C),

        /// <summary>
        /// The RPC protocol sequence was not found.
        /// </summary>
        RPC_NT_PROTSEQ_NOT_FOUND = unchecked((int)0xC002002D),

        /// <summary>
        /// The procedure number is out of range.
        /// </summary>
        RPC_NT_PROCNUM_OUT_OF_RANGE = unchecked((int)0xC002002E),

        /// <summary>
        /// The binding does not contain any authentication information.
        /// </summary>
        RPC_NT_BINDING_HAS_NO_AUTH = unchecked((int)0xC002002F),

        /// <summary>
        /// The authentication service is unknown.
        /// </summary>
        RPC_NT_UNKNOWN_AUTHN_SERVICE = unchecked((int)0xC0020030),

        /// <summary>
        /// The authentication level is unknown.
        /// </summary>
        RPC_NT_UNKNOWN_AUTHN_LEVEL = unchecked((int)0xC0020031),

        /// <summary>
        /// The security context is invalid.
        /// </summary>
        RPC_NT_INVALID_AUTH_IDENTITY = unchecked((int)0xC0020032),

        /// <summary>
        /// The authorization service is unknown.
        /// </summary>
        RPC_NT_UNKNOWN_AUTHZ_SERVICE = unchecked((int)0xC0020033),

        /// <summary>
        /// The entry is invalid.
        /// </summary>
        EPT_NT_INVALID_ENTRY = unchecked((int)0xC0020034),

        /// <summary>
        /// The operation cannot be performed.
        /// </summary>
        EPT_NT_CANT_PERFORM_OP = unchecked((int)0xC0020035),

        /// <summary>
        /// No more endpoints are available from the endpoint mapper.
        /// </summary>
        EPT_NT_NOT_REGISTERED = unchecked((int)0xC0020036),

        /// <summary>
        /// No interfaces have been exported.
        /// </summary>
        RPC_NT_NOTHING_TO_EXPORT = unchecked((int)0xC0020037),

        /// <summary>
        /// The entry name is incomplete.
        /// </summary>
        RPC_NT_INCOMPLETE_NAME = unchecked((int)0xC0020038),

        /// <summary>
        /// The version option is invalid.
        /// </summary>
        RPC_NT_INVALID_VERS_OPTION = unchecked((int)0xC0020039),

        /// <summary>
        /// There are no more members.
        /// </summary>
        RPC_NT_NO_MORE_MEMBERS = unchecked((int)0xC002003A),

        /// <summary>
        /// There is nothing to unexport.
        /// </summary>
        RPC_NT_NOT_ALL_OBJS_UNEXPORTED = unchecked((int)0xC002003B),

        /// <summary>
        /// The interface was not found.
        /// </summary>
        RPC_NT_INTERFACE_NOT_FOUND = unchecked((int)0xC002003C),

        /// <summary>
        /// The entry already exists.
        /// </summary>
        RPC_NT_ENTRY_ALREADY_EXISTS = unchecked((int)0xC002003D),

        /// <summary>
        /// The entry was not found.
        /// </summary>
        RPC_NT_ENTRY_NOT_FOUND = unchecked((int)0xC002003E),

        /// <summary>
        /// The name service is unavailable.
        /// </summary>
        RPC_NT_NAME_SERVICE_UNAVAILABLE = unchecked((int)0xC002003F),

        /// <summary>
        /// The network address family is invalid.
        /// </summary>
        RPC_NT_INVALID_NAF_ID = unchecked((int)0xC0020040),

        /// <summary>
        /// The requested operation is not supported.
        /// </summary>
        RPC_NT_CANNOT_SUPPORT = unchecked((int)0xC0020041),

        /// <summary>
        /// No security context is available to allow impersonation.
        /// </summary>
        RPC_NT_NO_CONTEXT_AVAILABLE = unchecked((int)0xC0020042),

        /// <summary>
        /// An internal error occurred in the RPC.
        /// </summary>
        RPC_NT_INTERNAL_ERROR = unchecked((int)0xC0020043),

        /// <summary>
        /// The RPC server attempted to divide an integer by zero.
        /// </summary>
        RPC_NT_ZERO_DIVIDE = unchecked((int)0xC0020044),

        /// <summary>
        /// An addressing error occurred in the RPC server.
        /// </summary>
        RPC_NT_ADDRESS_ERROR = unchecked((int)0xC0020045),

        /// <summary>
        /// A floating point operation at the RPC server caused a divide by zero.
        /// </summary>
        RPC_NT_FP_DIV_ZERO = unchecked((int)0xC0020046),

        /// <summary>
        /// A floating point underflow occurred at the RPC server.
        /// </summary>
        RPC_NT_FP_UNDERFLOW = unchecked((int)0xC0020047),

        /// <summary>
        /// A floating point overflow occurred at the RPC server.
        /// </summary>
        RPC_NT_FP_OVERFLOW = unchecked((int)0xC0020048),

        /// <summary>
        /// An RPC is already in progress for this thread.
        /// </summary>
        RPC_NT_CALL_IN_PROGRESS = unchecked((int)0xC0020049),

        /// <summary>
        /// There are no more bindings.
        /// </summary>
        RPC_NT_NO_MORE_BINDINGS = unchecked((int)0xC002004A),

        /// <summary>
        /// The group member was not found.
        /// </summary>
        RPC_NT_GROUP_MEMBER_NOT_FOUND = unchecked((int)0xC002004B),

        /// <summary>
        /// The endpoint mapper database entry could not be created.
        /// </summary>
        EPT_NT_CANT_CREATE = unchecked((int)0xC002004C),

        /// <summary>
        /// The object UUID is the nil UUID.
        /// </summary>
        RPC_NT_INVALID_OBJECT = unchecked((int)0xC002004D),

        /// <summary>
        /// No interfaces have been registered.
        /// </summary>
        RPC_NT_NO_INTERFACES = unchecked((int)0xC002004F),

        /// <summary>
        /// The RPC was canceled.
        /// </summary>
        RPC_NT_CALL_CANCELLED = unchecked((int)0xC0020050),

        /// <summary>
        /// The binding handle does not contain all the required information.
        /// </summary>
        RPC_NT_BINDING_INCOMPLETE = unchecked((int)0xC0020051),

        /// <summary>
        /// A communications failure occurred during an RPC.
        /// </summary>
        RPC_NT_COMM_FAILURE = unchecked((int)0xC0020052),

        /// <summary>
        /// The requested authentication level is not supported.
        /// </summary>
        RPC_NT_UNSUPPORTED_AUTHN_LEVEL = unchecked((int)0xC0020053),

        /// <summary>
        /// No principal name was registered.
        /// </summary>
        RPC_NT_NO_PRINC_NAME = unchecked((int)0xC0020054),

        /// <summary>
        /// The error specified is not a valid Windows RPC error code.
        /// </summary>
        RPC_NT_NOT_RPC_ERROR = unchecked((int)0xC0020055),

        /// <summary>
        /// A security package-specific error occurred.
        /// </summary>
        RPC_NT_SEC_PKG_ERROR = unchecked((int)0xC0020057),

        /// <summary>
        /// The thread was not canceled.
        /// </summary>
        RPC_NT_NOT_CANCELLED = unchecked((int)0xC0020058),

        /// <summary>
        /// Invalid asynchronous RPC handle.
        /// </summary>
        RPC_NT_INVALID_ASYNC_HANDLE = unchecked((int)0xC0020062),

        /// <summary>
        /// Invalid asynchronous RPC call handle for this operation.
        /// </summary>
        RPC_NT_INVALID_ASYNC_CALL = unchecked((int)0xC0020063),

        /// <summary>
        /// Access to the HTTP proxy is denied.
        /// </summary>
        RPC_NT_PROXY_ACCESS_DENIED = unchecked((int)0xC0020064),

        /// <summary>
        /// The list of RPC servers available for auto-handle binding has been exhausted.
        /// </summary>
        RPC_NT_NO_MORE_ENTRIES = unchecked((int)0xC0030001),

        /// <summary>
        /// The file designated by DCERPCCHARTRANS cannot be opened.
        /// </summary>
        RPC_NT_SS_CHAR_TRANS_OPEN_FAIL = unchecked((int)0xC0030002),

        /// <summary>
        /// The file containing the character translation table has fewer than 512 bytes.
        /// </summary>
        RPC_NT_SS_CHAR_TRANS_SHORT_FILE = unchecked((int)0xC0030003),

        /// <summary>
        /// A null context handle is passed as an [in] parameter.
        /// </summary>
        RPC_NT_SS_IN_NULL_CONTEXT = unchecked((int)0xC0030004),

        /// <summary>
        /// The context handle does not match any known context handles.
        /// </summary>
        RPC_NT_SS_CONTEXT_MISMATCH = unchecked((int)0xC0030005),

        /// <summary>
        /// The context handle changed during a call.
        /// </summary>
        RPC_NT_SS_CONTEXT_DAMAGED = unchecked((int)0xC0030006),

        /// <summary>
        /// The binding handles passed to an RPC do not match.
        /// </summary>
        RPC_NT_SS_HANDLES_MISMATCH = unchecked((int)0xC0030007),

        /// <summary>
        /// The stub is unable to get the call handle.
        /// </summary>
        RPC_NT_SS_CANNOT_GET_CALL_HANDLE = unchecked((int)0xC0030008),

        /// <summary>
        /// A null reference pointer was passed to the stub.
        /// </summary>
        RPC_NT_NULL_REF_POINTER = unchecked((int)0xC0030009),

        /// <summary>
        /// The enumeration value is out of range.
        /// </summary>
        RPC_NT_ENUM_VALUE_OUT_OF_RANGE = unchecked((int)0xC003000A),

        /// <summary>
        /// The byte count is too small.
        /// </summary>
        RPC_NT_BYTE_COUNT_TOO_SMALL = unchecked((int)0xC003000B),

        /// <summary>
        /// The stub received bad data.
        /// </summary>
        RPC_NT_BAD_STUB_DATA = unchecked((int)0xC003000C),

        /// <summary>
        /// Invalid operation on the encoding/decoding handle.
        /// </summary>
        RPC_NT_INVALID_ES_ACTION = unchecked((int)0xC0030059),

        /// <summary>
        /// Incompatible version of the serializing package.
        /// </summary>
        RPC_NT_WRONG_ES_VERSION = unchecked((int)0xC003005A),

        /// <summary>
        /// Incompatible version of the RPC stub.
        /// </summary>
        RPC_NT_WRONG_STUB_VERSION = unchecked((int)0xC003005B),

        /// <summary>
        /// The RPC pipe object is invalid or corrupt.
        /// </summary>
        RPC_NT_INVALID_PIPE_OBJECT = unchecked((int)0xC003005C),

        /// <summary>
        /// An invalid operation was attempted on an RPC pipe object.
        /// </summary>
        RPC_NT_INVALID_PIPE_OPERATION = unchecked((int)0xC003005D),

        /// <summary>
        /// Unsupported RPC pipe version.
        /// </summary>
        RPC_NT_WRONG_PIPE_VERSION = unchecked((int)0xC003005E),

        /// <summary>
        /// The RPC pipe object has already been closed.
        /// </summary>
        RPC_NT_PIPE_CLOSED = unchecked((int)0xC003005F),

        /// <summary>
        /// The RPC call completed before all pipes were processed.
        /// </summary>
        RPC_NT_PIPE_DISCIPLINE_ERROR = unchecked((int)0xC0030060),

        /// <summary>
        /// No more data is available from the RPC pipe.
        /// </summary>
        RPC_NT_PIPE_EMPTY = unchecked((int)0xC0030061),
        ...
        /// </summary>
        STATUS_GRAPHICS_OPM_PARAMETER_ARRAY_TOO_SMALL = unchecked((int)0xC01E0504),
        ...
        /// </summary>
        STATUS_GRAPHICS_PVP_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME = unchecked((int)0xC01E0506),

        /// <summary>
        /// This function failed because the GDI display device passed to it was not attached to the Windows desktop.
        /// </summary>
        STATUS_GRAPHICS_PVP_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP = unchecked((int)0xC01E0507),

        /// <summary>
        /// The PVP does not support mirroring display devices because they do not have any protected outputs.
        /// </summary>
        STATUS_GRAPHICS_PVP_MIRRORING_DEVICES_NOT_SUPPORTED = unchecked((int)0xC01E0508),
        ...
        /// </summary>
        STATUS_GRAPHICS_OPM_INVALID_POINTER = unchecked((int)0xC01E050A),
        ...
        /// </summary>
        STATUS_GRAPHICS_PVP_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE = unchecked((int)0xC01E050D),
        ...
        /// </summary>
        STATUS_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS = unchecked((int)0xC01E051B),
        ...
        /// </summary>
        STATUS_FVE_FAILED_BAD_FS = unchecked((int)0xC0210005),
        ...
        /// </summary>
        STATUS_FWP_TOO_MANY_BOOTTIME_FILTERS = unchecked((int)0xC0220018),
        ...
        /// </summary>
        STATUS_FWP_INCOMPATIBLE_AUTH_CONFIG = unchecked((int)0xC0220038),

        /// <summary>
        /// The IPsec cipher configuration is not compatible with the cipher type.
        /// </summary>
        STATUS_FWP_INCOMPATIBLE_CIPHER_CONFIG = unchecked((int)0xC0220039),
