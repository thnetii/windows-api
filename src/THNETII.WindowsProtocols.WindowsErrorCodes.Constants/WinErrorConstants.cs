...
namespace THNETII.WindowsProtocols.WindowsErrorCodes.Constants
{
    public static class WinErrorConstants
    {
        ...
        /// </summary>
        public const int ERROR_CONTROL_C_EXIT = 572; // winnt
        ...
        /// </summary>
        public const int ERROR_FLOAT_MULTIPLE_FAULTS = 630; // winnt

        /// <summary>
        /// {EXCEPTION}
        /// Multiple floating point traps.
        /// </summary>
        public const int ERROR_FLOAT_MULTIPLE_TRAPS = 631; // winnt
        ...
        /// </summary>
        public const int ERROR_DBG_EXCEPTION_NOT_HANDLED = 688; // winnt
        ...
        /// </summary>
        public const int ERROR_DBG_TERMINATE_THREAD = 691; // winnt

        /// <summary>
        /// Debugger terminated process.
        /// </summary>
        public const int ERROR_DBG_TERMINATE_PROCESS = 692; // winnt

        /// <summary>
        /// Debugger got control C.
        /// </summary>
        public const int ERROR_DBG_CONTROL_C = 693; // winnt
        ...
        /// </summary>
        public const int ERROR_DBG_CONTROL_BREAK = 696; // winnt

        /// <summary>
        /// Debugger command communication exception.
        /// </summary>
        public const int ERROR_DBG_COMMAND_EXCEPTION = 697; // winnt
        ...
        /// </summary>
        public const int ERROR_SEGMENT_NOTIFICATION = 702; // winnt
        ...
        /// </summary>
        public const int ERROR_ABANDONED_WAIT_0 = 735; // winnt
        ...
        /// ERROR_USER_APC
        /// </summary>
        public const int ERROR_USER_APC = 737; // winnt
        ...
        /// </summary>
        public const int ERROR_DBG_EXCEPTION_HANDLED = 766; // winnt

        /// <summary>
        /// Debugger continued
        /// </summary>
        public const int ERROR_DBG_CONTINUE = 767; // winnt
