...
namespace THNETII.WinApi.Native.WinBase.Test
{
    ...
    public static class FormatMessageA
    {
        [FactWindowsOS]
        public static void Call_FormatString_StringBuilder()
        {
            ...
            Span<IntPtr> arguments = stackalloc IntPtr[]
            {
                (IntPtr)4,
                (IntPtr)2,
                Marshal.StringToCoTaskMemAnsi("Bill"),
                Marshal.StringToCoTaskMemAnsi("Bob"),
                (IntPtr)6,
                IntPtr.Zero
            };
        ...
        public static void Call_FormatString_StringOut()
        {
            ...
            try
            {
                int messageLength = FormatMessageA(
                    dwFlags: FORMAT_MESSAGE_FLAGS.FORMAT_MESSAGE_FROM_STRING,
                    dwWidth: default,
                    lpSource: formatString,
                    dwMessageId: 0,
        ...
        {
            IntPtr formatString = Marshal.StringToCoTaskMemAnsi("%1!*.*s! %4 %5!*s!");
            Span<IntPtr> arguments = stackalloc IntPtr[]
            {
                (IntPtr)4,
                (IntPtr)2,
            ...
            try
            {
                ...
                {
                    Span<byte> messageBuffer = stackalloc byte[bufferLength];
                    int messageLength = FormatMessageA(
                        dwFlags: FORMAT_MESSAGE_FLAGS.FORMAT_MESSAGE_FROM_STRING,
                        dwWidth: default,
                        ...
                        default:
                            unsafe
                            {
                                fixed (byte* messagePointer = messageBuffer)
                                    message = Marshal.PtrToStringAnsi(
        ...
        public static unsafe void Call_FormatString_SpanOut()
        {
            ...
            try
            {
                ...
                string message = messageBuffer.Pointer.MarshalAsAnsiString(messageLength);
        ...
        public static void Call_Win32Error_SpanOut(int errorcode)
        {
            ...
            string message = messagePointer.Pointer
                .MarshalAsAnsiString(messageLength);
